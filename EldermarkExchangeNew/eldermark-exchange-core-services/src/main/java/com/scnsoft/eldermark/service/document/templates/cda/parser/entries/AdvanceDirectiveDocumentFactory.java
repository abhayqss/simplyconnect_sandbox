...
public class AdvanceDirectiveDocumentFactory {
    ...
    public static List<AdvanceDirectiveDocument> parseReferenceDocuments(EList<Reference> references, AdvanceDirective advanceDirective, Client client) {
        if (CollectionUtils.isEmpty(references) || client == null) {
            return null;
        }
