...
public interface CustodianFactory extends
        SingleHeaderFactory<Custodian, com.scnsoft.eldermark.entity.document.ccd.Custodian>,
        ParsableSingleHeader<Custodian, com.scnsoft.eldermark.entity.document.ccd.Custodian> {
}
