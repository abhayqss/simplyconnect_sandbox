...
@Component
class ClientLastNameSubmittedScFieldBuilder extends AbstractSubmittedScFieldBuilder {

    public ClientLastNameSubmittedScFieldBuilder() {
        super(ScSourceTemplateFieldType.CLIENT_LAST_NAME);
    }
    ...
    public Stream<DocumentSignatureRequestSubmittedField> build(
        ...
        return Stream.ofNullable(context.getClient())
                .map(client -> {
                    ...
                    submittedField.setValue(client.getLastName());
