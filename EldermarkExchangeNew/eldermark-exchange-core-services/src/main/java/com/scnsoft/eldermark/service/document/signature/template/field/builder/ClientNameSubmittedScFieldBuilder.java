...
@Component
class ClientNameSubmittedScFieldBuilder extends AbstractSubmittedScFieldBuilder {

    public ClientNameSubmittedScFieldBuilder() {
        super(ScSourceTemplateFieldType.CLIENT_NAME);
    }
    ...
    public Stream<DocumentSignatureRequestSubmittedField> build(
        ...
        return Stream.ofNullable(context.getClient())
                .map(client -> {
                    ...
                    submittedField.setValue(client.getFullName());
