...
@Component
public class CurrentYearDefaultValueBuilder implements FieldDefaultValueBuilder {

    @Override
    public TemplateFieldDefaultValueType getTemplateFieldType() {
        return TemplateFieldDefaultValueType.CURRENT_YEAR;
    }
    ...
    public Object build(DocumentSignatureTemplateContext context) {
        ...
        return String.valueOf(LocalDate.now(zoneOffset).getYear() % 100);
    }
}
