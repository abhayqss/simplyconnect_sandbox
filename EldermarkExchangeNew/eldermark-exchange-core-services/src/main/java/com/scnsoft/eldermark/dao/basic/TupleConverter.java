...
/**
 * Analog of {@link org.springframework.data.jpa.repository.query.AbstractJpaQuery.TupleConverter}
 * modified to use {@link AppProjectionReturnedType}
 */
public class TupleConverter implements Converter<Object, Object> {
    ...
    /**
     * Creates a new {@link TupleConverter} for the given {@link AppProjectionReturnedType}.
     *
     * @param type must not be {@literal null}.
     */
    public TupleConverter(AppProjectionReturnedType type) {
    ...
    /**
     * Analog of {@link org.springframework.data.jpa.repository.query.AbstractJpaQuery.TupleConverter.TupleBackedMap}
     *
     */
