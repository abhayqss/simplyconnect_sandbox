...
public class PlanOfCareActivityFactory {
    ...
    public List<PlanOfCareActivity> parseSupplies(Client resident, EList<Supply> supplies) {
        ...
        for (Supply supply : supplies) {
            ...
            planOfCareActivity.setOrganization(resident.getOrganization());
    ...
    public List<PlanOfCareActivity> parseSubstanceAdministrations(Client resident, EList<SubstanceAdministration> substanceAdministrations) {
    ...
    public List<PlanOfCareActivity> parseProcedures(Client resident, EList<Procedure> procedures) {
    ...
    public List<PlanOfCareActivity> parseEncounters(Client resident, EList<Encounter> encounters) {
    ...
    public List<PlanOfCareActivity> parseObservations(Client resident, EList<Observation> observations) {
    ...
    public <A extends Act> List<PlanOfCareActivity> parseActs(Client resident, EList<A> planOfCareActivityActs) {
    ...
    private PlanOfCareActivity parseObservation(Client resident, Observation observation) {
    ...
    private PlanOfCareActivity parseAct(Client resident, Act ccdPlanOfCareActivityAct) {
