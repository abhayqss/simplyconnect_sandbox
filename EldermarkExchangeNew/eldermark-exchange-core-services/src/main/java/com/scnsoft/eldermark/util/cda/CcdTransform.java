...
public class CcdTransform {
    /**
     * Convert ED to String. <br/>
     * Implementation details:
     * <ol>
     * <li>ED > text is returned if present;</li>
     * <li>if ED is null or ED > text is empty, then the first non-null defaultValue
     * is returned.</li>
     * </ol>
     *
     * @see ED
     ...
     * <ol>
     * <li>ED > text is returned if present;</li>
     * <li>if ED is null or ED > text is empty, then code > displayName is
     * returned;</li>
    ...
    /**
     * Convert IVL_TS to a date pair. <br/>
     * Example from CCD:
     *
     * <pre>
     * {@code <effectiveTime>
    ...
    /**
     * Fetch center date from IVL_TS. <br/>
     * Example from CCD:
     *
     * <pre>
     * {@code <effectiveTime>
    ...
    /**
     * Fetch center date or value from effectiveTimefrom IVL_TS <br/>
     * Example from CCD:
     *
     * <pre>
     * {@code <effectiveTime>
    ...
    /**
     * Convert IVL_TS to a date pair of (high.value, low.value) if these values are
     * present, or to pair (null, center.value) or to to pair (null, value). Return
     * value is never null.
     * <p>
     * <br/>
     * Example from CCD:
    ...
    /**
     * Convert IVL_TS to a date pair of (high, low) if these values are present, of
     * to pair (null, value) otherwise. Return value is never null.
     * <p>
     * <br/>
     * Example from CCD:
     *
     ...
     * <p>
     * <br/>
     * Result: (null, 2013) Implementation details:
     * <ol>
     * <li>IVL_TS > high (if present) is parsed and returned as the first date;</li>
     * <li>IVL_TS > low (if present) is parsed and returned as the second date;</li>
     * <li>if IVL_TS is null, then null is returned.</li>
    ...
    public static BigDecimal PQtoBigDecimal(PQ src) {
        if (CcdParseUtils.hasContent(src) && src.getValue() != null) {
            return src.getValue();
        }
        return null;
    ...
    public static Community toCommunity(org.eclipse.mdht.uml.cda.Organization organization, Organization orgEntity,
                                        String legacyTable) {
        ...
        return CcdParseUtils.createCommunity(names, addresses, telecoms, orgEntity, legacyTable, legacyId);
    }

    public static Community toCommunity(org.eclipse.mdht.uml.cda.CustodianOrganization organization,
                                        Organization orgEntity, String legacyTable) {
        if (!CcdParseUtils.hasContent(organization)) {
            return null;
        }
        ...
        return CcdParseUtils.createOrganization(organization.getName(), organization.getAddrs(),
                organization.getTelecom(), orgEntity, legacyTable, legacyId);
    }
