...
@Component
public class ClientHomePhoneDefaultValueBuilder implements FieldDefaultValueBuilder {

    @Override
    public TemplateFieldDefaultValueType getTemplateFieldType() {
        return TemplateFieldDefaultValueType.CLIENT_HOME_PHONE;
    }
    ...
    public Object build(DocumentSignatureTemplateContext context) {
        return Optional.ofNullable(context.getClient())
                ...
                .flatMap(person -> PersonTelecomUtils.findValue(person, PersonTelecomCode.HP))
                .orElse(null);
    }
}
