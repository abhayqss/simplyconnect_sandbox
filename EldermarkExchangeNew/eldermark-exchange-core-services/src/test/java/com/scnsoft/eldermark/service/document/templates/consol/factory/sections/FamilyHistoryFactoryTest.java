...
public class FamilyHistoryFactoryTest {
...
//              assertEquals(CcdUtils.formatSimpleDate(familyHistoryMock.getDeceasedTime()), subjectPerson.getSDTCDeceasedTime().getValue());
            ...
            var familyHistoryObservationList = familyHistoryOrganizer.getFamilyHistoryObservations();
            ...
            for (FamilyHistoryObservation observationMock : familyHistoryMock.getFamilyHistoryObservations()) {
                var observationCcd = TestUtil.getObservationById(observationMock.getId(), familyHistoryObservationList);
