...
public class FamilyHistoryFactoryTest {
    ...
    public void testBuildingTemplate() throws Exception {
        ...
        var familyHistoryList = new ArrayList<FamilyHistory>();
        ...
        var familyHistoryOrganizerList = familyHistorySection.getFamilyHistoryOrganizers();
        assertEquals(familyHistoryList.size(), familyHistoryOrganizerList.size());

        for (int i = 0; i < familyHistoryList.size(); i++) {
            var familyHistoryOrganizer = familyHistoryOrganizerList.get(i);
