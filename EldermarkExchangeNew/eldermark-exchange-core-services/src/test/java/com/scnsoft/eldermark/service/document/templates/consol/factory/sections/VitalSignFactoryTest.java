...
public class VitalSignFactoryTest {
    ...
    public void testBuildingTemplate() {
        ...
        final VitalSignsSectionEntriesOptional vitalSignsSection = vitalSignFactory.buildTemplateInstance(vitalSignList);

        assertNotNull(vitalSignsSection);
        //EasyMock.verify(daoMock);

        assertEquals("2.16.840.1.113883.10.20.22.2.4.1", vitalSignsSection.getTemplateIds().get(0).getRoot());
        ...
        for (VitalSign vitalSignMock : vitalSignList) {
            VitalSignsOrganizer vitalSignsOrganizer = TestUtil.getOrganizerById(vitalSignMock.getId(), vitalSignsOrganizerList);
            ...
            assertEquals("2.16.840.1.113883.10.20.22.4.26", vitalSignsOrganizer.getTemplateIds().get(0).getRoot());
            ...
            for (VitalSignObservation observationMock : vitalSignMock.getVitalSignObservations()) {
                ...
                assertEquals("2.16.840.1.113883.10.20.22.4.27", observationCcd.getTemplateIds().get(0).getRoot());
