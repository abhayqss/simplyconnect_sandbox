...
public class PayerFactoryTest {
    ...
    public void testBuildingTemplate() {
        ...
        for (Payer payerMock : payerList) {
            var coverageActivity = TestUtil.getActById(payerMock.getCoverageActivityId(), coverageActivityList);
            ...
            if (!CollectionUtils.isEmpty(payerMock.getPolicyActivities())) {
                ...
                for (var policyActivityMock : payerMock.getPolicyActivities()) {
                    var policyActivityCcd =
                            TestUtil.getActById(policyActivityMock.getId(), policyActivityList);
                    ...
                    Community payerCommunityMock = policyActivityMock.getPayerCommunity();
                    ...
                    if (payerCommunityMock != null) {
                       ...
                       // assertEquals(payerOrganizationMock.getId().toString(), assignedEntity.getIds().get(0).getExtension());
                        ...
                        assertPerformerOrganizations(payerCommunityMock, assignedEntity);
                    ...
                    Community guarantorCommunity = policyActivityMock.getGuarantorCommunity();
                    ...
                    if (guarantorCommunity != null || guarantorPerson != null) {
                        ...
                        if (guarantorCommunity != null) {
                            assertPerformerOrganizations(guarantorCommunity, assignedEntity);
                        } else {
...
//    }
    ...
    private void assertPerformerOrganizations(Community communityMock, AssignedEntity assignedEntity) {
