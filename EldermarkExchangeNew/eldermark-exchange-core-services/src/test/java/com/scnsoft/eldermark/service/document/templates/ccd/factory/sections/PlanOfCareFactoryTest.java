...
public class PlanOfCareFactoryTest {
    ...
    public void testBuildingTemplate() {
        ...
        for (var planOfCareActivityMock : planOfCareMock.getPlanOfCareActivityActList()) {
            Act planOfCareActivityAct = TestUtil.getActById(planOfCareActivityMock.getId(), planOfCareActivityActList);
        ...
        for (var planOfCareActivityMock : planOfCareMock.getPlanOfCareActivityEncounterList()) {
        ...
        for (var planOfCareActivityMock : planOfCareMock.getPlanOfCareActivityObservationList()) {
        ...
        for (var planOfCareActivityMock : planOfCareMock.getPlanOfCareActivityProcedureList()) {
        ...
        for (var planOfCareActivityMock : planOfCareMock.getPlanOfCareActivitySubstanceAdministrationList()) {
        ...
        for (var planOfCareActivityMock : planOfCareMock.getPlanOfCareActivitySupplyList()) {
