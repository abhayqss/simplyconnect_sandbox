...
public class ProblemsFactoryTest {
    ...
    public void testBuildingTemplate() {
        ...
        // problem observation
        List<Observation> problemObservations = getSubList(problemAct.getObservations(), org.openhealthtools.mdht.uml.cda.ccd.ProblemObservation.class);
        ...
        var problemObservation = problemObservations.get(0);
