...
public class CsTrackingReportClientRow {
    ...
    private List<CsTrackingReportInsuranceAuthorizationDto> insuranceAuthorizations;

    private Instant csFaceToFaceFirstEncounterDate;
    ...
    private Instant lastHousingAssessmentCompleteDate;
    private Long totalNumberCompletedHousingAssessment;
    ...
    public List<CsTrackingReportInsuranceAuthorizationDto> getInsuranceAuthorizations() {
        return insuranceAuthorizations;
    }

    public void setInsuranceAuthorizations(List<CsTrackingReportInsuranceAuthorizationDto> insuranceAuthorizations) {
        this.insuranceAuthorizations = insuranceAuthorizations;
    }

    public Instant getCsFaceToFaceFirstEncounterDate() {
        return csFaceToFaceFirstEncounterDate;
    }

    public void setCsFaceToFaceFirstEncounterDate(Instant csFaceToFaceFirstEncounterDate) {
        this.csFaceToFaceFirstEncounterDate = csFaceToFaceFirstEncounterDate;
    }
    ...
    public Instant getLastHousingAssessmentCompleteDate() {
        return lastHousingAssessmentCompleteDate;
    }

    public void setLastHousingAssessmentCompleteDate(Instant lastHousingAssessmentCompleteDate) {
        this.lastHousingAssessmentCompleteDate = lastHousingAssessmentCompleteDate;
    }

    public Long getTotalNumberCompletedHousingAssessment() {
        return totalNumberCompletedHousingAssessment;
    }

    public void setTotalNumberCompletedHousingAssessment(Long totalNumberCompletedHousingAssessment) {
        this.totalNumberCompletedHousingAssessment = totalNumberCompletedHousingAssessment;
    }
}