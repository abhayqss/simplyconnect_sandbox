...
public class AdtPD1AdditionalDemographicSegment implements Serializable {
    ...
    @ElementCollection
    @CollectionTable(name = "ADT_FIELD_PD1_LivingDependency_LIST", joinColumns = @JoinColumn(name = "PD1_Id"))
