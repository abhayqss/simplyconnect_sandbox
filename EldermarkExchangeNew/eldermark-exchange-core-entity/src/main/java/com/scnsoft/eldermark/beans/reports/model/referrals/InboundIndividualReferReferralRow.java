...
public class InboundIndividualReferReferralRow extends ReferReferralRow {

    private String ReferringIndividualName;

    private long numberOfReferredClients;
    ...
    public long getNumberOfReferredClients() {
        return numberOfReferredClients;
    }

    public void setNumberOfReferredClients(long numberOfReferredClients) {
        this.numberOfReferredClients = numberOfReferredClients;
    }
