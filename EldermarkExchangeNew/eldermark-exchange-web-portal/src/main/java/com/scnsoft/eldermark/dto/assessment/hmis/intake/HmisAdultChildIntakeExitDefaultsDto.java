...
public class HmisAdultChildIntakeExitDefaultsDto extends AssessmentDefaultsDto {
    ...
    public static class FamilyMember {
        ...
        public static class ForwardingAddress {
        ...
        public ForwardingAddress getForwardingAddress() {
            return forwardingAddress;
        }

        public void setForwardingAddress(final ForwardingAddress forwardingAddress) {
