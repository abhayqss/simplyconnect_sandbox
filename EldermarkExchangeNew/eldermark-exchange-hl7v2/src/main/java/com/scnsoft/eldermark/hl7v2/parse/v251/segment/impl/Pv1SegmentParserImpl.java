...
import com.scnsoft.eldermark.hl7v2.parse.v251.segment.Pv1SegmentParser;
import com.scnsoft.eldermark.hl7v2.source.MessageSource;
import org.springframework.stereotype.Service;

@Service
public class Pv1SegmentParserImpl extends AbstractAdtSegmentParser<PV1ClientVisitSegment, PV1>
        implements Pv1SegmentParser {

    @Override
    public PV1ClientVisitSegment doParse(PV1 segment, MessageSource messageSource) {
        ...
        pv1.setAdmittingDoctors(dataTypeService.createXCNList(segment.getPv117_AdmittingDoctor()));
        ...
        pv1.setOtherHealthcareProviders(dataTypeService.createXCNList(segment.getPv152_OtherHealthcareProvider()));
        return pv1;
    }
}
