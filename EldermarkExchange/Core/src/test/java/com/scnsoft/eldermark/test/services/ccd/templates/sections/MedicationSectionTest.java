...
import com.scnsoft.eldermark.services.ccd.templates.sections.MedicationsFactory;
...
public class MedicationSectionTest {
    ...
    public void testBuildingTemplate() {
        ...
        assertEquals("2.16.840.1.113883.10.20.1.8", section.getTemplateIds().get(0).getRoot());
