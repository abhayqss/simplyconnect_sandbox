...
import com.scnsoft.eldermark.services.consol.templates.sections.FamilyHistoryFactory;
...
public class FamilyHistorySectionTest {
    ...
    public void testBuildingTemplate() throws Exception {
        ...
        assertEquals("2.16.840.1.113883.10.20.22.2.15", familyHistorySection.getTemplateIds().get(0).getRoot());
        ...
        List<FamilyHistoryOrganizer> familyHistoryOrganizerList = familyHistorySection.getFamilyHistories();
...
//              assertEquals(CcdUtils.formatSimpleDate(familyHistoryMock.getDeceasedTime()), subjectPerson.getSDTCDeceasedTime().getValue());
            ...
            List<org.openhealthtools.mdht.uml.cda.consol.FamilyHistoryObservation> familyHistoryObservationList = familyHistoryOrganizer.getFamilyHistoryObservations();
            ...
            for (FamilyHistoryObservation observationMock : familyHistoryMock.getFamilyHistoryObservations()) {
                org.openhealthtools.mdht.uml.cda.consol.FamilyHistoryObservation observationCcd = (org.openhealthtools.mdht.uml.cda.consol.FamilyHistoryObservation) TestUtil.getObservationById(observationMock.getId(), familyHistoryObservationList);
