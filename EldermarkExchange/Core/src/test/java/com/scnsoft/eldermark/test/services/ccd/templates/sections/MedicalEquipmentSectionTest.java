...
import com.scnsoft.eldermark.entity.ProductInstance;
import com.scnsoft.eldermark.services.ccd.templates.sections.MedicalEquipmentFactory;
...
public class MedicalEquipmentSectionTest {
    ...
    public void testBuildingTemplate() {
        ...
        assertEquals("2.16.840.1.113883.10.20.1.7", section.getTemplateIds().get(0).getRoot());
