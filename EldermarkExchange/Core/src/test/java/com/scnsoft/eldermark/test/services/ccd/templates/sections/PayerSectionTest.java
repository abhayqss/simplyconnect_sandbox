...
import com.scnsoft.eldermark.services.ccd.templates.sections.PayerFactory;
...
public class PayerSectionTest {
    ...
    public void testBuildingTemplate() {
        ...
        for (Payer payerMock : payerList) {
            ...
            List<org.openhealthtools.mdht.uml.cda.ccd.PolicyActivity> policyActivityList = coverageActivity.getPolicyActivities();
            ...
            if (!CollectionUtils.isEmpty(payerMock.getPolicyActivities())) {
                ...
                for (PolicyActivity policyActivityMock : payerMock.getPolicyActivities()) {
                    org.openhealthtools.mdht.uml.cda.ccd.PolicyActivity policyActivityCcd =
                            (org.openhealthtools.mdht.uml.cda.ccd.PolicyActivity) TestUtil.getActById(policyActivityMock.getId(), policyActivityList);
