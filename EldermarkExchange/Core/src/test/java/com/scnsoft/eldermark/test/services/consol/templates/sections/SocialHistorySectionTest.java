...
import com.scnsoft.eldermark.services.consol.templates.sections.SocialHistoryFactory;
...
public class SocialHistorySectionTest {
    ...
    public void testBuildingTemplate() {
        ...
        smokingStatusObservationMock.setValue(TestUtil.createCcdCodeMock());
        ...
        tobaccoUseMock.setValue(TestUtil.createCcdCodeMock());
        ...
        assertEquals("2.16.840.1.113883.10.20.22.2.17", section.getTemplateIds().get(0).getRoot());
        ...
        assertEquals("2.16.840.1.113883.10.20.22.4.38", observation.getTemplateIds().get(0).getRoot());
...
//        assertTrue(section.getText().getText().contains(socialHistoryObservationMock.getFreeText()));
        ...
        assertEquals("OBS", observation.getClassCode().toString());
        assertEquals("EVN", observation.getMoodCode().toString());
        assertEquals("2.16.840.1.113883.10.20.15.3.8", observation.getTemplateIds().get(0).getRoot());
        ...
        assertEquals("OBS", observation.getClassCode().toString());
        assertEquals("EVN", observation.getMoodCode().toString());
        assertEquals("2.16.840.1.113883.10.20.15.3.1", observation.getTemplateIds().get(0).getRoot());
        assertEquals("completed", observation.getStatusCode().getCode());
        ...
        assertEquals("OBS", observation.getClassCode().toString());
        assertEquals("EVN", observation.getMoodCode().toString());
        assertEquals("2.16.840.1.113883.10.20.22.4.78", observation.getTemplateIds().get(0).getRoot());
        assertEquals("ASSERTION", observation.getCode().getCode());
        assertEquals("completed", observation.getStatusCode().getCode());
        ...
        assertEquals(smokingStatusObservationMock.getValue().getCode(), ((CD) observation.getValues().get(0)).getCode());
        assertEquals(smokingStatusObservationMock.getValue().getCodeSystem(), ((CD) observation.getValues().get(0)).getCodeSystem());
        ...
        assertEquals("OBS", observation.getClassCode().toString());
        assertEquals("EVN", observation.getMoodCode().toString());
        assertEquals("2.16.840.1.113883.10.20.22.4.85", observation.getTemplateIds().get(0).getRoot());
        assertEquals("ASSERTION", observation.getCode().getCode());
        assertEquals("completed", observation.getStatusCode().getCode());
        assertEquals(CcdUtils.formatSimpleDate(smokingStatusObservationMock.getEffectiveTimeLow()), observation.getEffectiveTime().getLow().getValue());
        assertEquals(tobaccoUseMock.getValue().getCode(), ((CD) observation.getValues().get(0)).getCode());
        assertEquals(tobaccoUseMock.getValue().getCodeSystem(), ((CD) observation.getValues().get(0)).getCodeSystem());
    }
}
