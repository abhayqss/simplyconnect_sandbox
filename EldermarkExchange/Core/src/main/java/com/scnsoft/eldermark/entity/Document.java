...
public class Document {
    ...
    private List<Database> sharedWithDatabases;
    ...
    public List<Database> getSharedWithDatabases() {
        return sharedWithDatabases;
    }

    public List<Long> getSharedWithDatabasesIds() {
        List<Long> sharedWithDatabasesIds = new ArrayList<Long>();
        if (sharedWithDatabases != null) {
            for (Database database : sharedWithDatabases) {
                sharedWithDatabasesIds.add(database.getId());
            }
        }
        return sharedWithDatabasesIds;
    }

    public void setSharedWithDatabases(List<Database> sharedWithDatabases) {
        this.sharedWithDatabases = sharedWithDatabases;
    }
