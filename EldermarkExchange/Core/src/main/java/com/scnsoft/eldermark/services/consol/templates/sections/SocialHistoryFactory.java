...
public class SocialHistoryFactory extends OptionalTemplateFactory implements SectionFactory<SocialHistorySection, SocialHistory> {
    ...
    private enum TemplateId {
         ...
         *
         * @deprecated Smoking Status Observation templateId was changed on the Nov 29, 2012 (SDWG call)
         */
        ...
        /**
         * Represents current and/or prior pregnancy dates enabling investigators to determine if the subject of the case report was pregnant
         * during the course of a condition.
         */
        PREGNANCY("2.16.840.1.113883.10.20.15.3.8"),
        /**
         * Defines the patient’s occupational, personal (e.g., lifestyle), social, and environmental history and health risk factors,
         ...
         * The 2015 Edition CEHRT requirements included a requirement to collect Birth Sex. The {@code administrativeGenderCode} is not
         * the appropriate place to specify Birth Sex.
         */
    ...
    public SocialHistorySection buildTemplateInstance(Collection<SocialHistory> socialHistory) {
        ...
        for (SocialHistory socialHistoryEntry : socialHistory) {
            if (socialHistoryEntry.getSocialHistoryObservations() != null) {
            ...
            if (socialHistoryEntry.getPregnancyObservations() != null) {
            ...
            if (socialHistoryEntry.getTobaccoUses() != null) {
    ...
    private Observation buildTobaccoUse(TobaccoUse tobaccoUse) {
        ...
        observation.getValues().add(CcdUtils.createCD(tobaccoUse.getValue(), CodeSystem.SNOMED_CT.getOid()));
    ...
    private Observation buildSmokingStatusObservation(SmokingStatusObservation smokingStatusObservation) {
        ...
        observation.getValues().add(CcdUtils.createCD(smokingStatusObservation.getValue(), CodeSystem.SNOMED_CT.getOid()));
    ...
    private Observation buildPregnancyObservation(PregnancyObservation pregnancyObservation) {
        ...
        if (pregnancyObservation.getEstimatedDateOfDelivery() != null) {
            ...
            Observation observation1 = prebuildObservation(SocialHistoryFactory.TemplateId.ESTIMATED_DATE_OF_DELIVERY, observationCode);
    ...
    private static String buildSectionText(Collection<SocialHistory> socialHistory) {
        ...
        sectionText.append("<th>Social History Element</th>");
        sectionText.append("<th>Description</th>");
        sectionText.append("<th>Effective Dates</th>");
        sectionText.append("</tr>");
        sectionText.append("</thead>");
        ...
        for (SocialHistory socialHistoryEntry : socialHistory) {
            if (socialHistoryEntry.getSocialHistoryObservations() != null) {
                for (SocialHistoryObservation socialHistoryObservation : socialHistoryEntry.getSocialHistoryObservations()) {
                    ...
                    if (socialHistoryObservation.getFreeText() != null) {
                        CcdUtils.addReferenceToSectionText(SocialHistoryObservation.class.getSimpleName() + socialHistoryObservation.getId(), socialHistoryObservation.getFreeText(), sectionText);
                    } else {
                    ...
                    sectionText.append("<td>");
                    if (socialHistoryObservation.getValue() != null && socialHistoryObservation.getValue().getDisplayName() != null) {
                        sectionText.append(StringEscapeUtils.escapeHtml4(socialHistoryObservation.getValue().getDisplayName()));
                    } else if (socialHistoryObservation.getFreeTextValue() != null) {
                        sectionText.append(StringEscapeUtils.escapeHtml4(socialHistoryObservation.getFreeTextValue()));
                    } else {
                        CcdUtils.addEmptyCellToSectionText(sectionText);
                    }
                    sectionText.append("</td>");
            ...
            if (socialHistoryEntry.getPregnancyObservations() != null) {
                for (PregnancyObservation pregnancyObservation : socialHistoryEntry.getPregnancyObservations()) {
                    ...
                    sectionText.append("<td>");
                    sectionText.append("Pregnant");
                    sectionText.append("</td>");

                    sectionText.append("<td>");
                    if (pregnancyObservation.getEstimatedDateOfDelivery() != null) {
                        sectionText.append("Estimated Date of Delivery: " + StringEscapeUtils.escapeHtml4(CcdUtils.formatTableDate(pregnancyObservation.getEstimatedDateOfDelivery())));
                    } else {
                        CcdUtils.addEmptyCellToSectionText(sectionText);
                    }
                    sectionText.append("</td>");

                    CcdUtils.addDateCell(pregnancyObservation.getEffectiveTimeLow(), sectionText);
            ...
            if (socialHistoryEntry.getSmokingStatusObservations() != null) {
                for (SmokingStatusObservation smokingStatusObservation : socialHistoryEntry.getSmokingStatusObservations()) {
                    ...
                    sectionText.append("<td>");
                    sectionText.append("Smoking status");
                    sectionText.append("</td>");

                    sectionText.append("<td>");
                    if (smokingStatusObservation.getValue() != null && smokingStatusObservation.getValue().getDisplayName() != null) {
                        sectionText.append(StringEscapeUtils.escapeHtml4(smokingStatusObservation.getValue().getDisplayName()));
                    } else {
                        CcdUtils.addEmptyCellToSectionText(sectionText);
                    }
                    sectionText.append("</td>");

                    CcdUtils.addDateCell(smokingStatusObservation.getEffectiveTimeLow(), sectionText);
            ...
            if (socialHistoryEntry.getTobaccoUses() != null) {
                for (TobaccoUse tobaccoUse : socialHistoryEntry.getTobaccoUses()) {
                    ...
                    sectionText.append("<td>");
                    sectionText.append("Tobacco Use");
                    sectionText.append("</td>");

                    sectionText.append("<td>");
                    if (tobaccoUse.getValue() != null && tobaccoUse.getValue().getDisplayName() != null) {
                        sectionText.append(StringEscapeUtils.escapeHtml4(tobaccoUse.getValue().getDisplayName()));
                    } else {
                        CcdUtils.addEmptyCellToSectionText(sectionText);
                    }
                    sectionText.append("</td>");
                    ...
                    if (tobaccoUse.getEffectiveTimeLow() != null) {
                        CcdUtils.addDateRangeToSectionText(tobaccoUse.getEffectiveTimeLow(), null, sectionText);
                    } else {
                        CcdUtils.addEmptyCellToSectionText(sectionText);
                    }
                    sectionText.append("</td>");
