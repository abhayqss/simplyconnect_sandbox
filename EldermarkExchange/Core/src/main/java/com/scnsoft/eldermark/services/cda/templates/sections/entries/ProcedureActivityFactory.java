...
public class ProcedureActivityFactory {
    ...
    public ProcedureActivity parseProcedureObservation(Observation ccdObservation, Resident resident, String legacyTable) {
            ...
            for (Participant2 ccdParticipant2 : ccdObservation.getParticipants()) {
                switch (ccdParticipant2.getTypeCode()) {
                    case LOC:
                        ...
                        serviceDeliveryLocations.add(participantRoleFactory.parseServiceDeliveryLocation(ccdParticipant2.getParticipantRole(), resident, legacyTable));
                        break;
                }
            ...
            for (EntryRelationship ccdEntryRelationship : ccdObservation.getEntryRelationships()) {
                switch (ccdEntryRelationship.getTypeCode()) {
                    case COMP:
                        ...
                        break;
                    case SUBJ:
                        procedureActivity.setInstructions(instructionsFactory.parseInstructions(ccdEntryRelationship.getAct(), resident));
                        break;
                    case RSON:
                        if (indications == null) {
            ...
            for (Participant2 ccdParticipant2 : ccdAct.getParticipants()) {
                switch (ccdParticipant2.getTypeCode()) {
                    case LOC:
                        ...
                        serviceDeliveryLocations.add(participantRoleFactory.parseServiceDeliveryLocation(ccdParticipant2.getParticipantRole(),
    ...
    public ProcedureActivity parseProcedureActivity(org.eclipse.mdht.uml.cda.Procedure ccdProcedure, Resident resident, String legacyTable) {
            ...
            for (Participant2 ccdParticipant2 : ccdProcedure.getParticipants()) {
                switch (ccdParticipant2.getTypeCode()) {
                    case DEV:
                        ...
                        productInstances.add(participantRoleFactory.parseProductInstance(ccdParticipant2.getParticipantRole(), resident));
                        break;
                    case LOC:
                        if (serviceDeliveryLocations == null) {
                            serviceDeliveryLocations = new HashSet<>();
