...
public abstract class AbstractITextPdfFaxContentGenerator<T> implements FaxContentGenerator<T>  {
    ...
    AbstractITextPdfFaxContentGenerator() {}

    @Value("classpath:fax_header.png")
    ...
    @Override
    public byte[] generateFaxContent(FaxDto faxDto, T dto) throws DocumentException, IOException {
        ...
        document.open();
        createDocumentBody(document, faxDto, dto);
        document.close();
...
//        return res;
    ...
    protected abstract void createDocumentBody(Document document, FaxDto faxDto, T dto) throws DocumentException, IOException;
