 ...
 */
@Component
public class InNetworkInsurancesPopularDtoSupplier extends AbstractDtoListSupplier {
    ...
    public List<KeyValueDto> get() {
        List<InNetworkInsurance> insurances = inNetworkInsuranceDao.findPopularItems(new Sort(Arrays.asList(ORDER_BY_DISPLAY_NAME)));
