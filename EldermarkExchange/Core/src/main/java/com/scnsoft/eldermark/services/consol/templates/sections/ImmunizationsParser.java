...
public class ImmunizationsParser
    ...
    private Immunization parseImmunizationActivity(SubstanceAdministration substanceAdministration, Resident resident) {
        ...
        if (!CollectionUtils.isEmpty(substanceAdministration.getPerformers())) {
            ...
            immunization
                    .setPerformer(performer2Factory.parsePerson(ccdPerformer2, resident.getDatabase(), LEGACY_TABLE));
        }
    ...
    @Override
    public List<Immunization> doParseSection(Resident resident,
        ...
        for (SubstanceAdministration ccdImmunizationSubstanceAdministration : immunizationsSection
            ...
            final Immunization immunization = parseImmunizationActivity(ccdImmunizationSubstanceAdministration,
                    resident);
            if (filterImmunization(immunization)) {
