...
public class Name extends StringLegacyTableAwareEntity {
    ...
    @Column(name = "given_hash", insertable = false, updatable = false)
    ...
    @Column(name = "middle_hash", insertable = false, updatable = false)
    ...
    @Column(name = "family_hash", insertable = false, updatable = false)
