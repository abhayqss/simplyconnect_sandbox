...
public class FamilyHistoryParser
    ...
    @Override
    public List<FamilyHistory> doParseSection(Resident resident, FamilyHistorySection familyHistorySection) {
    ...
    private FamilyHistoryObservation parseFamilyHistoryObservation(
            org.openhealthtools.mdht.uml.cda.consol.FamilyHistoryObservation ccdObservation, Resident resident) {
