...
public class SectionEntryFactory {
    public static Observation buildReactionObservation(com.scnsoft.eldermark.entity.ReactionObservation reactionObservation, Set<Class> entriesReferredToSectionText) {
        Observation ccdReactionObservation = CCDFactory.eINSTANCE.createReactionObservation();
        ...
        if (reactionSeverities != null) {
            for (com.scnsoft.eldermark.entity.SeverityObservation severityObservation : reactionSeverities) {
        ...
        if (medications != null) {
            for (com.scnsoft.eldermark.entity.Medication medication : medications) {
                EntryRelationship entryRelationship1 = CDAFactory.eINSTANCE.createEntryRelationship();
    ...
    public static Observation buildSeverityObservation(com.scnsoft.eldermark.entity.SeverityObservation severityObservation, Set<Class> entriesReferredToSectionText) {
        Observation ccdSeverity = CCDFactory.eINSTANCE.createSeverityObservation();
    ...
    public static org.eclipse.mdht.uml.cda.Organization buildOrganization(com.scnsoft.eldermark.entity.Organization organization, boolean full) {
    ...
    public static Observation buildProblemObservation(ProblemObservation problemObservation, Set<Class> entriesReferredToSectionText) {
        org.openhealthtools.mdht.uml.cda.ccd.ProblemObservation problemObservationCcd = CCDFactory.eINSTANCE.createProblemObservation();
        ...
        if (problemObservation.getProblemStatusCode() != null || !StringUtils.isEmpty(problemObservation.getProblemStatusText())) {
            ProblemStatusObservation problemStatusObservation = CCDFactory.eINSTANCE.createProblemStatusObservation();
    ...
    public static Observation buildNullProblemObservation() {
        org.openhealthtools.mdht.uml.cda.ccd.ProblemObservation problemObservationCcd = CCDFactory.eINSTANCE.createProblemObservation();
    ...
    public static org.eclipse.mdht.uml.cda.Act buildProcedureAct(ProcedureActivity procedure, Set<Class> entriesReferredToSectionText) {
        org.eclipse.mdht.uml.cda.Act act = CDAFactory.eINSTANCE.createAct();
    ...
    public static org.eclipse.mdht.uml.cda.Observation buildProcedureObservation(ProcedureActivity procedure, Set<Class> entriesReferredToSectionText) {
        org.eclipse.mdht.uml.cda.Observation obs = CDAFactory.eINSTANCE.createObservation();
...
//        }
    ...
    public static AgeObservation buildAgeObservation(String unit, Integer value) {
        AgeObservation ageObservation = CCDFactory.eINSTANCE.createAgeObservation();
