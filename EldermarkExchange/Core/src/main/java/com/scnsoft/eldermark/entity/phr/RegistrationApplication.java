...
import com.scnsoft.eldermark.entity.phr.converter.RegistrationApplicationTypeConverter;
...
public class RegistrationApplication {
    ...
    @ManyToOne
    @JoinColumn(name = "registration_step", nullable = false)
    private RegistrationStep registrationStep;
    @Column(name = "registration_type", length = 8)
    @Convert(converter = RegistrationApplicationTypeConverter.class)
    private RegistrationApplication.Type registrationType;
