 ...
 * <br/>Immunizations section uses the same sample templates as Medications.
 * <br/>This section is optional, however it is strongly recommended that it be present in cases of pediatric care and
 * in other cases when such information is available.
 *
 * @see Immunization
 ...
 */
@Component
public class ImmunizationsFactory extends OptionalTemplateFactory implements ParsableSectionFactory<ImmunizationsSection, Immunization> {
    ...
    private SubstanceAdministration buildImmunizationActivity(Immunization immunization, Set<Class> entriesReferredToSectionText) {
        ...
        if (immunization.getText() != null) {
            if (entriesReferredToSectionText.contains(Immunization.class)) {
                substanceAdministration.setText(CcdUtils.createReferenceEntryText(Immunization.class.getSimpleName() + immunization.getId()));
            } else {
        ...
        if (immunization.getRoute() != null) {
            substanceAdministration.setRouteCode(CcdUtils.createCE(immunization.getRoute(), "2.16.840.1.113883.3.26.1.1"));
        }

        if (immunization.getSite() != null) {
            substanceAdministration.getApproachSiteCodes().add(CcdUtils.createCE(immunization.getSite(), CodeSystem.SNOMED_CT.getOid()));
        }
        ...
        if (immunization.getAdministrationUnitCode() != null) {
            substanceAdministration.setAdministrationUnitCode(CcdUtils.createCE(immunization.getAdministrationUnitCode(), "2.16.840.1.113883.3.26.1.1"));
        }

        Consumable consumable = CDAFactory.eINSTANCE.createConsumable();
        if (immunization.getImmunizationMedicationInformation() != null) {
            consumable.setManufacturedProduct(SectionEntryFactory.buildImmunizationMedicationInformation(immunization.getImmunizationMedicationInformation(), entriesReferredToSectionText));
        } else {
            consumable.setManufacturedProduct(SectionEntryFactory.buildNullImmunizationMedicationInformation());
        }
        ...
        if (!CollectionUtils.isEmpty(immunization.getDrugVehicles())) {
            for (DrugVehicle drugVehicle : immunization.getDrugVehicles()) {
                ...
                participant2.setParticipantRole(SectionEntryFactory.buildDrugVehicle(drugVehicle));
        ...
        if (immunization.getInstructions() != null) {
            ...
            entryRelationship.setAct(SectionEntryFactory.buildInstructions(immunization.getInstructions(), entriesReferredToSectionText));
            substanceAdministration.getEntryRelationships().add(entryRelationship);
        }
        ...
        if (immunization.getMedicationSupplyOrder() != null) {
            ...
            entryRelationship.setSupply(SectionEntryFactory.buildMedicationSupplyOrder(immunization.getMedicationSupplyOrder(), entriesReferredToSectionText));
            substanceAdministration.getEntryRelationships().add(entryRelationship);
        }
        ...
        if (immunization.getMedicationDispense() != null) {
            EntryRelationship entryRelationship = CDAFactory.eINSTANCE.createEntryRelationship();
            entryRelationship.setTypeCode(x_ActRelationshipEntryRelationship.REFR);
            entryRelationship.setSupply(SectionEntryFactory.buildMedicationDispense(immunization.getMedicationDispense(), entriesReferredToSectionText));
            substanceAdministration.getEntryRelationships().add(entryRelationship);
        }
        ...
        if (immunization.getReactionObservation() != null) {
            ...
            entryRelationship.setObservation(SectionEntryFactory.buildReactionObservation(immunization.getReactionObservation(), entriesReferredToSectionText));
            substanceAdministration.getEntryRelationships().add(entryRelationship);
        }
        ...
        if (!CollectionUtils.isEmpty(immunization.getPreconditions())) {
            for (MedicationPrecondition precondition : immunization.getPreconditions()) {
                substanceAdministration.getPreconditions().add(SectionEntryFactory.buildMedicationPrecondition(precondition));
            }
        }
        ...
        if (immunization.getImmunizationRefusalReason() != null) {
            EntryRelationship entryRelationship = CDAFactory.eINSTANCE.createEntryRelationship();
            entryRelationship.setTypeCode(x_ActRelationshipEntryRelationship.RSON);
            entryRelationship.setObservation(buildImmunizationRefusalReason(immunization.getImmunizationRefusalReason()));
            substanceAdministration.getEntryRelationships().add(entryRelationship);
        }

        if (immunization.getPerformer() != null) {
            substanceAdministration.getPerformers().add(SectionEntryFactory.buildPerformer2(immunization.getPerformer()));
        }
    ...
    private static String buildSectionText(Collection<Immunization> immunizations) {
        ...
        sectionText.append("<th>Vaccine</th>");
        ...
        for (Immunization immunization : immunizations) {
            ...
            if (medInformation != null) {
                ...
                if (productName != null) {
                    CcdUtils.addReferenceToSectionText(ImmunizationMedicationInformation.class.getSimpleName() + medInformation.getId(), productName, sectionText);
                } else {
            ...
            if (immunization.getImmunizationStarted() != null || immunization.getImmunizationStopped() != null) {
                CcdUtils.addDateRangeToSectionText(immunization.getImmunizationStarted(), immunization.getImmunizationStopped(), sectionText);
            } else {
                CcdUtils.addEmptyCellToSectionText(sectionText);
            }
            sectionText.append("</td>");
            ...
            sectionText.append("<td>");
            if (immunization.getStatusCode() != null) {
                sectionText.append(StringEscapeUtils.escapeHtml4(immunization.getStatusCode()));
            } else {
                CcdUtils.addEmptyCellToSectionText(sectionText);
            }
            sectionText.append("</td>");
    ...
    private Immunization parseImmunizationActivity(SubstanceAdministration substanceAdministration, Resident resident) {
        ...
        immunization.setDatabase(resident.getDatabase());
        ...
        immunization.setAdministrationUnitCode(ccdCodeFactory.convert(substanceAdministration.getAdministrationUnitCode()));

        if (substanceAdministration.getConsumable() != null) {
            immunization.setImmunizationMedicationInformation(sectionEntryParseFactory.parseImmunizationMedicationInformation(
                    substanceAdministration.getConsumable().getManufacturedProduct(), resident));
        }

        immunization.setDrugVehicles(sectionEntryParseFactory.parseDrugVehicles(substanceAdministration.getParticipants(), resident));
            ...
            for (EntryRelationship ccdEntryRelationship : substanceAdministration.getEntryRelationships()) {
                switch (ccdEntryRelationship.getTypeCode()) {
                    case RSON:
                        ...
                        // In order to distinguish between Indication and ImmunizationRefusalReason we check templateId
                        if (id != null && IMMUNIZATION_REFUSAL_REASON_TEMPLATE_ID.equals(id.getRoot())) {
                            immunization.setImmunizationRefusalReason(parseImmunizationRefusalReason(ccdEntryRelationship.getObservation(), resident));
                        } else {
                            if (indications == null) {
                                indications = new ArrayList<>();
                            }
                            Indication indication = sectionEntryParseFactory.parseIndication(
                                    observation, resident, LEGACY_TABLE);
                            indications.add(indication);
                        }
                        break;
                    case SUBJ:
                        immunization.setInstructions(sectionEntryParseFactory.parseInstructions(ccdEntryRelationship.getAct(), resident));
                        break;
                    case REFR:
                        Supply ccdSupply = ccdEntryRelationship.getSupply();
                        if (ccdSupply.getMoodCode() == x_DocumentSubstanceMood.EVN) {
                            immunization.setMedicationDispense(sectionEntryParseFactory.parseMedicationDispense(ccdSupply, resident, LEGACY_TABLE));
                        } else if (ccdSupply.getMoodCode() == x_DocumentSubstanceMood.INT) {
                            immunization.setMedicationSupplyOrder(sectionEntryParseFactory.parseMedicationSupplyOrder(ccdSupply, resident, LEGACY_TABLE));
                        } else {
                            logger.warn("parseMedicationActivity : Unknown EntryRelationship of type REFR and Supply moodCode = " + ccdSupply.getMoodCode());
                        }
                        break;
                    case CAUS:
                        immunization.setReactionObservation(sectionEntryParseFactory.parseReactionObservation(
                                ccdEntryRelationship.getObservation(), resident, LEGACY_TABLE));
                        break;
                }
            }
        ...
        immunization.setPreconditions(sectionEntryParseFactory.parsePreconditions(substanceAdministration.getPreconditions(), resident));
        ...
        if (!CollectionUtils.isEmpty(substanceAdministration.getPerformers())) {
            ...
            immunization.setPerformer(performer2Factory.parsePerson(ccdPerformer2, resident.getDatabase(), LEGACY_TABLE));
        }

        return immunization;
    }

    private ImmunizationRefusalReason parseImmunizationRefusalReason(Observation ccdObservation, Resident resident) {
        ...
        immunizationRefusalReason.setDatabase(resident.getDatabase());
    ...
    @Override
    public List<Immunization> parseSection(Resident resident, ImmunizationsSection immunizationsSection) {
        ...
        for (SubstanceAdministration ccdImmunizationSubstanceAdministration : immunizationsSection.getSubstanceAdministrations()) {
            immunizations.add(parseImmunizationActivity(ccdImmunizationSubstanceAdministration, resident));
        }
