...
public class SocialHistoryFactory extends OptionalTemplateFactory implements ParsableSectionFactory<SocialHistorySection, SocialHistory> {
     ...
     * </tbody>
     * </table>
     * @see com.scnsoft.eldermark.services.consol.templates.sections.SocialHistoryParser
     */
    private SocialHistoryObservation parseSocialHistoryObservationWithST(org.openhealthtools.mdht.uml.cda.ccd.SocialHistoryObservation ccdObservation, Resident resident) {
    ...
    @Override
    public List<SocialHistory> parseSection(Resident resident, SocialHistorySection socialHistorySection) {
        ...
        for (org.openhealthtools.mdht.uml.cda.ccd.SocialHistoryObservation ccdObservation : socialHistorySection.getSocialHistoryObservations()) {
            final SocialHistoryObservation socialHistoryObservation = parseSocialHistoryObservationWithST(ccdObservation, resident);
