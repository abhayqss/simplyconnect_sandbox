 ...
 */
@Component
public class InNetworkInsurancesDtoSupplier extends AbstractDtoListSupplier {
    ...
    public List<KeyValueDto> get() {
        List<InNetworkInsurance> insurances = inNetworkInsuranceDao.findAll(new Sort(Arrays.asList(ORDER_BY_IS_FIRST_GROUP_DESC, ORDER_BY_IS_POPULAR_DESC, ORDER_BY_DISPLAY_NAME)));
