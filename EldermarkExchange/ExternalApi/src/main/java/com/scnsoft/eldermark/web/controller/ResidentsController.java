...
public class ResidentsController {
    ...
    public ResponseEntity<byte[]> getResidentCcd(
        ...
        final Report ccdReport = documentFacade.generateContinuityOfCareDocument(residentId, Boolean.TRUE.equals(aggregated));
        return buildCcdResponseEntity(ccdReport);
    }

    private ResponseEntity<byte[]> buildCcdResponseEntity(Report report) throws IOException {
    ...
    private HttpHeaders buildCcdResponseHeaders(Report report) {
