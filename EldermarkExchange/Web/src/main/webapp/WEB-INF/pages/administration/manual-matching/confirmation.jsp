...
<lt:layout cssClass="modal fade" role="dialog" id="manualMatchingConfirmationModal">
    <lt:layout cssClass="modal-dialog" role="document" style="width:1000px;">
        <lt:layout cssClass="modal-content">
            <wg:modal-header closeBtn="true">
                <span id="manualMatchingConfirmationHeader" style="padding-left: 10px">Confirmation</span>
            </wg:modal-header>
            ...
            <wg:modal-footer-btn-group btnGroupCssClass="patientMatchesButtons">
                    <wg:button name="cancelBtn"
                               domType="link"
                               dataToggle="modal"
                               dataTarget="#manualMatchingConfirmationModal"
                               id="manualMatchingConfirmationCancelBtn"
                               cssClass="btn-default btn cancelBtn">
                        CANCEL
                    </wg:button>

                    <wg:button name="resolveBtn"
                               id="manualMatchingConfirmationSaveBtn"
                               domType="link"
                               dataToggle="modal"
