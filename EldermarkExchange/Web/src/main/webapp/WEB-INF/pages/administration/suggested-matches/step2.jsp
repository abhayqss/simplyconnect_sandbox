...
<div class="ldr-ui-layout patientsComparedNavigator ldr-center-block" style="padding:10px;">
    <ol class="breadcrumb">
        <li class="backToSuggestedMatches">
    ...
    <lt:layout style="margin: 0px" cssClass="patientListBox panel panel-primary clearfix">
        ...
        <lt:layout cssClass="boxBody">
            <table class="display transposed dataTable" cellspacing="0" role="grid"
                   style="vertical-align: top; display: inline-block; width: 196px;">
                <thead>
                <tr role="row">
            ...
            <wg:grid id="suggestedMatchesPatientsCompared"
                     cssClass="transposed"
                     colIds="selfUrl,firstName,lastName,genderDisplayName,dateOfBirth,ssn,streetAddress,city,state,postalCode,databaseName,organizationName,select"
                     colNames=" , First Name, Last Name, Gender, Date of Birth, Social Security #, Street Address, City, State, Zip Code, Organization, Community, Choose Matching Records"
                     dataUrl="administration/suggested-matches/patients"
                     dataRequestMethod="GET"
                     colFormats="custom,string,string,string,string,ssn,string,string,string,string,string,string,checkbox"/>
            ...
            <lt:layout cssClass="col-md-offset-8 form-inline buttons" style="padding-top: 20px">
                <wg:button domType="button" type="button" cssClass="btn-default cancelBtn"
                           id="suggestedMatchesCancel" name="suggestedMatchesCancel"
                >CANCEL</wg:button>

                <wg:button domType="button" type="submit" cssClass="btn-primary submitBtn"
                           name="suggestedMatchesResolve" id="suggestedMatchesResolve"
                >RESOLVE</wg:button>
            </lt:layout>
        </lt:layout>
    </lt:layout>
...
<%-- =================== Confirmation Modal ========================== --%>
<div id="suggestedMatchesConfirmationContainer"></div>
