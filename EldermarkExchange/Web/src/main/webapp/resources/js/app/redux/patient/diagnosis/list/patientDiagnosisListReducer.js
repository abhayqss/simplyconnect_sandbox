define(
    [
        ...
        path('./PatientDiagnosisListInitialState')
    ],
    function (varants, InitialState) {
        ...
        return function (state, action) {
            ...
            switch (action.type) {
                case types.CLEAN_PATIENT_DIAGNOSES:
                    return state
                        .removeIn(['error'])
                        .setIn(['isFetching'], false)
                        .removeIn(['dataSource', 'data']);

                case types.CLEAN_PATIENT_DIAGNOSIS_LIST_ERROR:
                    return state.removeIn(['error']);

                case types.LOAD_PATIENT_DIAGNOSES_REQUEST:
                    return state
                        .setIn(['error'], null)
                        .setIn(['isFetching'], true);

                case types.LOAD_PATIENT_DIAGNOSES_SUCCESS: {
                ...
                case types.LOAD_PATIENT_DIAGNOSES_FAILURE:
