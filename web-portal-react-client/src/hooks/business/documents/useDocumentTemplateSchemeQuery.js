...
function fetch(params) {
    return service.findTemplateSchemeById(params)
    /*return new Promise(resolve => {
        setTimeout(() => {
            resolve(AL_CONTRACT_ATT_E_FormJsonSchema)
        }, 2000)
    })*/
}

export default function useDocumentTemplateSchemeQuery(params, options) {
    return useQuery(['DocumentTemplateScheme', params], () => fetch(params), options)
}