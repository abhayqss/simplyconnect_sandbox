...
function RequestInfoEditor({ isOpen, onClose, onSubmit, requestId, referralId, infoRequestId }) {
  ...
  const title = isRequest ? "Request info" : "Reply to Request for Info";
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} hasFooter={false} hasCloseBtn={false} title={title} className="RequestInfoEditor">
        <Form
          requestId={requestId}
          onClose={onCloseForm}
