import React, { memo, useMemo, useState, useEffect, forwardRef, useCallback, useImperativeHandle } from "react";

import { values, compact, isNumber } from "underscore";
...
function AddToGroupConversationForm(
  ...
  console.log(fields.types.client, "fields.types.client");
            ...
            <Row>
              ...
              <Col md="12">
                <CheckboxField
                  ...
                  isDisabled={!fields.types.client || !accessibility.areClientCareTeamMembersAccessible}
