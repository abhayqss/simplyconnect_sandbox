...
import {
    useClientDocumentFilter,
    useClientIdChangesTracker,
    useClientDocumentFilterDirectory,
    useClientDocumentFilterDefaultDataCache
...
function DocumentFilter(
    ...
    } = useClientDocumentFilterDefaultDataCache({ clientId })
    ...
    useClientIdChangesTracker(clientId, (prevClientId) => {
        if (prevClientId) {
            reset()
        }
    })
