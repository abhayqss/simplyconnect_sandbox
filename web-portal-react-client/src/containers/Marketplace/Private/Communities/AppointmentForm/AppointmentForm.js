...
class AppointmentForm extends Component {
    ...
    constructor(props) {
        ...
        this.getServicesSelectOptions = memo(
            this.getServicesSelectOptions
        )
    }
    ...
    componentDidMount () {
        ...
        if (isInteger(clientId)) {
            ...
            this.actions.contact.load(id, true)
                .then(Response(({ data }) => {
                    this.actions.changeFields({
    ...
    getServicesSelectOptions() {
        const {
            services, primaryFocuses
        } = this.getDirectoryData()

        return map(
            groupBy(services, 'primaryFocusId'),
            (data, id) => ({
                id: +id,
...
export default connect(mapStateToProps, mapDispatchToProps)(
    withDirectoryData(AppointmentForm)
)