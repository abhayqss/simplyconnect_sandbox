...
import { ONLY_VIEW_ROLES, SYSTEM_ROLES, VENDOR_ROLES } from "../../../../../lib/Constants";
      ...
      <div className="vendorDetailLeftBox">
        <div className="vendorDetailInfo">
          <div className="vendorDetailInfoHeader">
            ...
            <Button color="success" outline disabled={!detailData?.canRefer} onClick={setVendorReferModalOpen}>
              Refer
            </Button>
          </div>
