...
import { clearBuildingDetail } from "../../../../../redux/marketplace/Building/BuildingActions";
import { ONLY_VIEW_ROLES, SYSTEM_ROLES } from "lib/Constants";

const BuildingDetailLeft = (props) => {
  const { communityId, organizationId } = props;
    ...
    <>
      ...
      <div className="detailHeader">
        ...
        <div className="detailHeaderRight">
          <Button color="success" outline onClick={onOpenReferralRequestEditor}>
            Refer
          </Button>
        </div>
      </div>
