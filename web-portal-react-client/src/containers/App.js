...
import { useExternalProviderUrlCheck, useExternalProviderRoleCheck } from "hooks/business/external";

import { useConversationsInitialization } from "hooks/business/conversations";
...
import { MessageNotificator, Authentication as ConversationsAuthentication } from "containers/Communication/Messenger";
...
function App({ location, history }) {
  ...
  slk(process.env.REACT_APP_SURVEY_LICENSEKEY);
