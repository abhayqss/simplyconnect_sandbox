...
import {
  CASE_MANAGER_ROLE,
  NON_CLINICAL_STAFF_ONLY_VIEW_ROLES,
  ONLY_VIEW_ROLES,
  PAGINATION,
  SYSTEM_ROLES,
} from "../../../../lib/Constants";
...
const AssociationDetail = (props) => {
  ...
  const [isDetailTableFetching, setIsDetailTableFetching] = useState(false);
  ...
  const isInAssociationSystem =
    NON_CLINICAL_STAFF_ONLY_VIEW_ROLES.includes(user.roleName) || CASE_MANAGER_ROLE.includes(user.roleName);
  ...
  const tabNameList = ["community", "vendor", "organization"];
            ...
            <>
              ...
              <div className="AssociationDetail-Header">
                ...
                <div className="AssociationDetail-ControlPanel">
                  {associationDetailData && !isInAssociationSystem && (
