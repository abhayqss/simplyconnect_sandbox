...
export class ReferralService extends BaseService {
  ...
  reply(params) {
    return super.request({
      url: `/clients/${params.clientId}/medications/${params.medicationId}/medicationIntake?intake=${params.intake}&smsId=${params.smsId}`,
    });
  }

  findMedicationDetails(clientId, medDeliveryId) {
    return super.request({
      method: "GET",
      url: `/clients/${clientId}/medications/${medDeliveryId}/medDelivery`,
    });
  }
