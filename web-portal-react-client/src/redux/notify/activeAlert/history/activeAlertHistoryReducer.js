import InitialState from './ActiveAlertHistoryInitialState'
...
export default function activeAlertHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case LOGOUT_SUCCESS:
        case CLEAR_ACTIVE_ALERT_HISTORY:
        ...
        case CLEAR_ACTIVE_ALERT_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_ACTIVE_ALERT_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_ACTIVE_ALERT_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_ACTIVE_ALERT_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
