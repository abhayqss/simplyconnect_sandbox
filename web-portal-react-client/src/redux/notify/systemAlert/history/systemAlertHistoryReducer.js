import InitialState from './SystemAlertHistoryInitialState'
...
export default function systemAlertHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case LOGOUT_SUCCESS:
        case CLEAR_SYSTEM_ALERT_HISTORY:
        ...
        case CLEAR_SYSTEM_ALERT_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_SYSTEM_ALERT_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_SYSTEM_ALERT_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_SYSTEM_ALERT_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
