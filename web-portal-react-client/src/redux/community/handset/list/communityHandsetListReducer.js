import InitialState from './CommunityHandsetListInitialState'
...
export default function communityListReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_COMMUNITY_HANDSET_LIST:
        ...
        case CLEAR_COMMUNITY_HANDSET_LIST_ERROR:
            return state.removeIn(['error'])

        case CLEAR_COMMUNITY_HANDSET_LIST_FILTER:
            return state.removeIn(['dataSource', 'filter', 'name'])

        case CHANGE_COMMUNITY_HANDSET_LIST_FILTER: {
        ...
        case LOAD_COMMUNITY_HANDSET_LIST_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_COMMUNITY_HANDSET_LIST_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_COMMUNITY_HANDSET_LIST_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
