import InitialState from './CommunityHistoryInitialState'
...
export default function communityHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_COMMUNITY_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_COMMUNITY_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_COMMUNITY_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_COMMUNITY_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
