import InitialState from './CareTeamMemberHistoryInitialState'
...
export default function careTeamMemberHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case LOGOUT_SUCCESS:
        case CLEAR_CARE_TEAM_MEMBER_HISTORY:
        ...
        case CLEAR_CARE_TEAM_MEMBER_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_CARE_TEAM_MEMBER_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_CARE_TEAM_MEMBER_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_CARE_TEAM_MEMBER_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
