import InitialState from './AppointmentHistoryInitialState'
...
export default function appointmentHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case LOGOUT_SUCCESS:
        case CLEAR_DASHBOARD_APPOINTMENT_HISTORY:
        ...
        case CLEAR_DASHBOARD_APPOINTMENT_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_DASHBOARD_APPOINTMENT_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_DASHBOARD_APPOINTMENT_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_DASHBOARD_APPOINTMENT_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
