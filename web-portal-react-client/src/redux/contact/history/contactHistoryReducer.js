import InitialState from './ContactHistoryInitialState'
...
export default function contactHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_CONTACT_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_CONTACT_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_CONTACT_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_CONTACT_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
