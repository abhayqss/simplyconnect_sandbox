...
import createContactValidator from "validators/CreatContactFormValidator";
...
const {
  ...
  EDIT_INVITED_ASSOCIATION_REQUEST,
  EDIT_INVITED_ASSOCIATION_SUCCESS,
  EDIT_INVITED_ASSOCIATION_ERROR,
} = ACTION_TYPES;
...
export function submitCreateContact(data) {
  return (dispatch) => {
...
export function editCreateContact(data) {
  return (dispatch) => {
    dispatch({ type: SAVE_CONTACT_REQUEST });
    return adminVendorService
...
export function submitAssociationCreateContact(data) {
  return (dispatch) => {
    dispatch({ type: SAVE_CONTACT_REQUEST });
    return adminAssociationsService
      .saveAssociationContactData(data)
      .then((response) => {
        dispatch({ type: SAVE_CONTACT_SUCCESS, payload: response });
        return response;
      })
...
export function editAssociationContactData(data) {
  return (dispatch) => {
    dispatch({ type: SAVE_CONTACT_REQUEST });
    return adminAssociationsService
      .editAssociationTeamContactData(data)
      .then((response) => {
        dispatch({ type: SAVE_CONTACT_SUCCESS, payload: response });
        return response;
      })
