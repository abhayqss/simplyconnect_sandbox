...
export function ActionTypes(entity) {
    return {
        CLEAR: `CLEAR_${entity}_DATA`,
        REFRESH: `REFRESH_${entity}_DATA`,
        CLEAR_ERROR: `CLEAR_${entity}_ERROR`,
        LOAD_REQUEST: `LOAD_${entity}_DATA_REQUEST`,
        LOAD_SUCCESS: `LOAD_${entity}_DATA_SUCCESS`,
        LOAD_FAILURE: `LOAD_${entity}_DATA_FAILURE`,
        DOWNLOAD_FAILURE: `DOWNLOAD_${entity}_DATA_FAILURE`
    }
}
