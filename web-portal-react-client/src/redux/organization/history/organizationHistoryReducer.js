import InitialState from './OrganizationHistoryInitialState'
...
export default function organizationHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_ORGANIZATION_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_ORGANIZATION_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_ORGANIZATION_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_ORGANIZATION_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
