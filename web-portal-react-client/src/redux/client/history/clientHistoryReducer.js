import InitialState from './ClientHistoryInitialState'
...
export default function clientHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_CLIENT_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_CLIENT_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_CLIENT_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_CLIENT_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
