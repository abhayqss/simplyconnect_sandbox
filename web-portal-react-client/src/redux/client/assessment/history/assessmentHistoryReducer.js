import InitialState from './AssessmentHistoryInitialState'
...
export default function assessmentHistoryReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_ASSESSMENT_HISTORY_ERROR:
            return state.removeIn(['error'])

        case LOAD_ASSESSMENT_HISTORY_REQUEST:
            return state
            .setIn(['error'], null)
            .setIn(['shouldReload'], false)
            .setIn(['isFetching'], true)

        case LOAD_ASSESSMENT_HISTORY_SUCCESS: {
            const {
                data,
                page,
                size,
        ...
        case LOAD_ASSESSMENT_HISTORY_FAILURE:
            return state
                .setIn(['isFetching'], false)
                .setIn(['shouldReload'], false)
