...
import "./SelectFieldLevel.scss";
import LevelMultiSelect from "../../LevelMultiSelect/LevelMultiSelect";

export default class SelectFieldLevel extends PureComponent {
  static propTypes = {
    ...
    hasChildSearch: PropTypes.bool,
    childSearchText: PropTypes.string,
    isDisabled: PropTypes.bool,
    isShowFolderIcon: PropTypes.bool,
    isShowRightChevron: PropTypes.bool,
  ...
  onChange = (value, onCancelSelect) => {
    this.props.onChange(this.props.name, value, onCancelSelect);
  };

  onChangeSearchText = (value, onCancelSelect) => {
    this.props.onChangeSearchText(this.props.name, value, onCancelSelect);
  };

  onChangeCustomValue = (value, onCancelSelect) => {
    this.props.onChangeCustomValue(this.props.name, value, onCancelSelect);
  };

  onBlurCustomValueBox = (value, onCancelSelect) => {
    this.props.onBlurCustomValueBox(this.props.name, value, onCancelSelect);
  };
  ...
  render() {
    ...
    return (
      <FormGroup
        className={cn("SelectField", { SelectField_disabled: isDisabled }, className)}
        data-testid={`${name}_field`}
        {...restProps}
      >
        {label && (
          <>
            <Label data-testid={`${name}_field-label`} className="SelectField-Label">
              {label}
            </Label>
        ...
        <LevelMultiSelect
          ...
          isShowRightChevron={isShowRightChevron}
          ...
          hasChildSearch={hasChildSearch}
        />
        {hasError ? <div className="SelectField-Error">{errorText}</div> : null}
