...
set form_ui_schema = '{"day":{"ui:options":{"maxLength":2}},"month":{"ui:field":"SelectField","ui:options":{"isMultiple":false}},"year":{"ui:options":{"maxLength":2}},"facility":{"ui:options":{"maxLength":256}},"resident":{"ui:options":{"maxLength":256}},"arbitrationAgreementSignatures":{"rescissionStartDate":{"ui:field":"DateField"},"facilityName":{"ui:options":{"maxLength":256}},"facilityAddress":{"ui:options":{"maxLength":256}},"facilityAddress2":{"ui:options":{"maxLength":256}},"rescissionEndDate":{"ui:field":"DateField"},"ui:grid":[{"facilityName":{"md":4},"facilityAddress":{"md":4},"facilityAddress2":{"md":4}},{"rescissionStartDate":{"md":6},"rescissionEndDate":{"md":6}}]},"ui:grid":[{"day":{"md":4},"month":{"md":4},"year":{"md":4}},{"facility":{"md":6},"resident":{"md":6}},{"arbitrationAgreementSignatures":{"md":12}}]}',
    form_schema    = '{"type":"object","properties":{"day":{"type":"string","title":"Day","format":"number"},"month":{"title":"Month","enum":["January","February","March","April","May","June","July","August","September","October","November","December"]},"year":{"type":"string","title":"The last 2 digits of a year","format":"number"},"facility":{"title":"Facility","type":"string"},"resident":{"title":"Resident","type":"string"},"arbitrationAgreementSignatures":{"type":"object","title":"Notice Of Right To Rescind binding Arbitration Clause","properties":{"rescissionStartDate":{"title":"Date rescission period begins"},"facilityName":{"title":"Facility name","type":"string"},"facilityAddress":{"title":"Facility address","type":"string"},"facilityAddress2":{"title":"Facility address 2","type":"string"},"rescissionEndDate":{"title":"Last day for rescission"}}}}}'
...
values (@signature_template_field_id, 'FONT_FAMILY', 'HELVETICA'),
...
values (@signature_template_field_id, null, 100, 98, 125, 113, 1)
...
values (@signature_template_field_id, 'FONT_FAMILY', 'HELVETICA'),
       (@signature_template_field_id, 'TEXT_ALIGNMENT', 'ALIGN_CENTER')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 157, 98, 249, 113, 1)
...
values (@signature_template_field_id, 'FONT_FAMILY', 'HELVETICA'),
       (@signature_template_field_id, 'TEXT_ALIGNMENT', 'ALIGN_CENTER')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 258, 98, 281, 113, 1)
...
values (@signature_template_field_id, 'FONT_FAMILY', 'HELVETICA')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 295, 98, 495, 112, 1)
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'title', 'TEXT', null, null, (select id from DocumentSignatureTemplateField where name = 'arbitrationAgreementSignatures.signature' and signature_template_id = @signature_template_id), null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'conservatorOf', 'CHECKBOX', null, null, (select id from DocumentSignatureTemplateField where name = 'residentRepresentativeSignature' and signature_template_id = @signature_template_id), null)
select @signature_template_field_id = scope_identity()

insert into DocumentSignatureTemplateFieldStyle(signature_template_field_id, type, value)
values (@signature_template_field_id, 'FONT_SIZE', '8.0')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 73, 530, 81, 538, 3)
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'guardianOf', 'CHECKBOX', null, null, (select id from DocumentSignatureTemplateField where name = 'residentRepresentativeSignature' and signature_template_id = @signature_template_id), null)
select @signature_template_field_id = scope_identity()

insert into DocumentSignatureTemplateFieldStyle(signature_template_field_id, type, value)
values (@signature_template_field_id, 'FONT_SIZE', '8.0')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 73, 541, 81, 549, 3)
...
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 212, 308, 266, 322, 4)
