if col_length('DocumentSignatureTemplate', 'deleted_by_id') is not null
    begin
        alter table DocumentSignatureTemplate
            drop constraint FK_DocumentSignatureTemplate_Employee_enc_deleted_by
        alter table DocumentSignatureTemplate
            drop column deleted_by_id
    end
go

if col_length('DocumentSignatureTemplate', 'delete_datetime') is not null
    begin
        alter table DocumentSignatureTemplate
            drop column delete_datetime
    end
go

alter table DocumentSignatureTemplate
    add deleted_by_id bigint
        constraint FK_DocumentSignatureTemplate_Employee_enc_deleted_by foreign key (deleted_by_id) references Employee_enc (id)
go

alter table DocumentSignatureTemplate
    add delete_datetime datetime2(7)
go
