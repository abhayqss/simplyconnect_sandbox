...
ALTER TABLE [dbo].[resident_enc] ADD [created_by_id] [bigint]
ALTER TABLE [dbo].[resident_enc] ADD [legacy_table] [varchar] (100)
GO
ALTER TABLE [dbo].[resident_enc]  WITH CHECK ADD  CONSTRAINT [FK_resident_creator] FOREIGN KEY([created_by_id])
REFERENCES [dbo].[Employee_enc] ([id])
GO
ALTER TABLE [dbo].[resident_enc] CHECK CONSTRAINT [FK_resident_creator]
GO
...
INSERT INTO resident_enc
	...
	prev_addr_state,prev_addr_zip,advance_directive_free_text,first_name,last_name,middle_name,preferred_name,patient_account_number,birth_place,death_date,mother_account_number, created_by_id, legacy_table)
   SELECT
