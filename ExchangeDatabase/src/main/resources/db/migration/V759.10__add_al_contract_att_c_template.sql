...
values ('AL_CONTRACT_ATT_C',
        'Meal Plan (Att C)',
        '{"numberOfApt":{"ui:options":{"maxLength":128}},"provider":{"ui:options":{"maxLength":256}},"effectiveDate":{"ui:field":"DateField"},"ui:grid":[{"numberOfApt":{"lg":4,"md":12},"provider":{"lg":4,"md":12},"effectiveDate":{"lg":4,"md":12}}]}',
        '{"type":"object","properties":{"numberOfApt":{"type":"string","title":"Apt #"},"provider":{"type":"string","title":"Provider"},"effectiveDate":{"title":"Effective date"}},"required":["numberOfApt","provider","effectiveDate"]}')
go
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'threeMealsPerDayPlusSnack', 'CHECKBOX', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'wouldLikeToParticipateInMealPlan', 'CHECKBOX', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'doNotWantToParticipateInMealPlan', 'CHECKBOX', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'providerIts', 'TEXT', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'providerSignatureDate', 'SIGNATURE_DATE', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'residentSignatureDate', 'SIGNATURE_DATE', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'legalRepresentativeSignatureDate', 'SIGNATURE_DATE', null, null, null, null)
select @signature_template_field_id = scope_identity()
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'responsiblePartySignatureDate', 'SIGNATURE_DATE', null, null, null, null)
select @signature_template_field_id = scope_identity()
