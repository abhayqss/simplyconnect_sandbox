            ...
            },
            {
              ...
              "elements": [
                ...
                },
				{
                  "type": "comment",
                  "name": "question21",
				  "visibleIf": "{question3} = \"item1\" or {question20} = \"item1\"",
                  "title": "Describe",
                  "maxLength": 20000,
				  "validators": [
                    {
            ...
            },
            {
              ...
              "elements": [
                ...
                },
				{
                  "type": "comment",
                  "name": "question24",
				  "visibleIf": "{question3} = \"item1\" or {question23} = \"item1\"",
                  "title": "Describe",
                  "maxLength": 20000,
				  "validators": [
                    {
            ...
            },
            {
              ...
              "elements": [
                ...
                },
				{
                  "type": "comment",
                  "name": "question27",
				  "visibleIf": "{question3} = \"item1\" or {question26} = \"item1\"",
                  "title": "Describe",
                  "maxLength": 20000,
				  "validators": [
                    {
        ...
        },
        {
          ...
          "elements": [
            ...
            },
			{
                  "type": "radiogroup",
                  "name": "question32",
				  "visibleIf": "{question3} = \"item1\" and {question31} = \"item1\"",
...
SELECT @assessmentId = ID FROM Assessment WHERE short_name = 'C-SSRS';
