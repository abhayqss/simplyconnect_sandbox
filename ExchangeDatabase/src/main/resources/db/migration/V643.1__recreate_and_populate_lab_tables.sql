...
insert into SpecimenType(name, title, item_order) values
  ('ESWAB', 'ESwab', 1),
  ('CERVICAL_BRUSH', 'Cervical Brush', 2),
  ('NAIL', 'Nail', 3),
  ('URINE', 'Urine', 4),
  ('OTHER', 'Other', 5)
GO

insert into LabIcd10Group(name, title) values
  ('COVID19)', 'COVID-19 (SARS-CoV-2)')
GO

insert into LabIcd10Code(code, title, item_order, lab_icd10_group_id) values
  ('B97.29', 'B97.29', 1, 1),
  ('J12.89', 'J12.89', 2, 1),
  ('J20.8', 'J20.8', 3, 1),
  ('J22', 'J22', 4, 1),
 ...
 ('R06.02', 'R06.02', 9, 1),
 ('R50.9', 'R50.9', 10, 1),
 ('Z03.818', 'Z03.818', 11, 1),
 ('Z20.828', 'Z20.828', 12, 1)
GO