...
ALTER TABLE [dbo].[resident_enc] ADD 	[last_updated] [datetime2]
GO
...
as
 select
	...
	,created_by_id, legacy_table, [active], [last_updated]
...
INSERT INTO resident_enc
	...
	prev_addr_state,prev_addr_zip,advance_directive_free_text,first_name,last_name,middle_name,preferred_name,patient_account_number,birth_place,death_date,mother_account_number, created_by_id, legacy_table, [active],[last_updated])
   SELECT
