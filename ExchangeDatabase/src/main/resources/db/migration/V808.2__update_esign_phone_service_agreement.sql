...
where name = 'PHONE_SERVICE_AGREEMENT'
...
values (@signature_template_id, 'clientName', null, 'CLIENT_NAME', null, null, null)
...
values (@signature_template_field_id, 'FONT', 'ARIAL'),
       (@signature_template_field_id, 'FONT_SIZE', '10.0')
...
values (@signature_template_field_id, null, 156, 445, 342, 459, 1)
...
values (@signature_template_field_id, 'FONT', 'ARIAL'),
       (@signature_template_field_id, 'FONT_SIZE', '10.0')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 385, 445, 484, 459, 1)

insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'familyContact', 'TEXT', null, null, null, null)
select @signature_template_field_id = scope_identity()

insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 152, 489, 288, 503, 1)

insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'phone', 'TEXT', null, null, null, null)
select @signature_template_field_id = scope_identity()

insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 327, 489, 490, 503, 1)
...
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 156, 526, 216, 546, 1)

insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'residentPhone', null, 'TEXT', 'CLIENT_CELL_PHONE', null, null)
select @signature_template_field_id = scope_identity()
...
values (@signature_template_field_id, 'FONT', 'ARIAL'),
       (@signature_template_field_id, 'FONT_SIZE', '10.0')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 147, 638, 369, 652, 1)

insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'dateActivated', null, 'DATE', null, null, null)
select @signature_template_field_id = scope_identity()
...
values (@signature_template_field_id, 'FONT', 'ARIAL'),
       (@signature_template_field_id, 'FONT_SIZE', '10.0')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 133, 665, 281, 679, 1)

insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'dateDeactivated', null, 'DATE', null, null, null)
select @signature_template_field_id = scope_identity()
...
values (@signature_template_field_id, 'FONT', 'ARIAL'),
       (@signature_template_field_id, 'FONT_SIZE', '10.0')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 396, 665, 518, 679, 1)
