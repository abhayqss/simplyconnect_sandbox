/****** Object:  StoredProcedure [dbo].[load_ccd_medications]    Script Date: 05/06/2015 17:03:37 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[load_ccd_medications]
	@ResidentId bigint,
	@SortBy varchar(50), -- ['mdc_started'|'mdc_stopped | mdc_status_code']
...
BEGIN
	...
	-- pagination & output
	SELECT 
		RowNum as id, mdc_stopped, mdc_started, mdc_free_text_sig, mdc_status_code, mdc_info_product_name_text, ind_display_name, instr_text, indications
	FROM SortedTable
	WHERE 
