...
IF COL_LENGTH('ResidentAppointment_enc', 'is_external_provider_service_provider') IS NOT NULL
    BEGIN
        ALTER TABLE ResidentAppointment_enc
            DROP COLUMN is_external_provider_service_provider;
    END
GO

ALTER TABLE [dbo].[ResidentAppointment_enc]
    ADD [is_external_provider_service_provider] [bit] null;
GO
