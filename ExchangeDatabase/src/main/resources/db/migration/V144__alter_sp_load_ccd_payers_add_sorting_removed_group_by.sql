/****** Object:  StoredProcedure [dbo].[load_ccd_payer_providers]    Script Date: 05/29/2015 12:25:46 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[load_ccd_payer_providers]
	@ResidentId bigint,
	@SortBy varchar(50), -- ['payer_providers_insurance_info'|'payer_providers_insurance_type'|'payer_providers_time_heigh'|'payer_providers_time_low']
