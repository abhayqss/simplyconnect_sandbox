 /* CREATE KEY, CERTIFICATE, SYMMETRIC KEY  */

 CREATE MASTER KEY ENCRYPTION BY PASSWORD = 'qweAlk983_OEPO2IJSW123';
 CREATE CERTIFICATE Certificate1 WITH SUBJECT = 'Protect Data';
 CREATE SYMMETRIC KEY SymmetricKey1  WITH ALGORITHM = TRIPLE_DES_3KEY  ENCRYPTION BY CERTIFICATE Certificate1;

/* CREATE COPY OF RESIDENT TABLE + ENCRYPT EXISTED DATA */

 OPEN SYMMETRIC KEY SymmetricKey1 DECRYPTION BY CERTIFICATE Certificate1;

 select r.*,
  EncryptByKey (Key_GUID('SymmetricKey1'),ssn) ssn_enc,
  EncryptByKey (Key_GUID('SymmetricKey1'),ssn_last_four_digits) ssn_last_four_digits_enc,
  EncryptByKey (Key_GUID('SymmetricKey1'), CONVERT(varchar, birth_date,0)) birth_date_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),medical_record_number) medical_record_number_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),medicare_number) medicare_number_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),medicaid_number) medicaid_number_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),ma_authorization_number) ma_authorization_number_enc,
  EncryptByKey (Key_GUID('SymmetricKey1'), CONVERT(varchar, ma_auth_numb_expire_date,121)) ma_auth_numb_expire_date_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),prev_addr_street) prev_addr_street_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),prev_addr_city) prev_addr_city_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),prev_addr_state) prev_addr_state_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),prev_addr_zip) prev_addr_zip_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),advance_directive_free_text) advance_directive_free_text_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),first_name) first_name_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),last_name) last_name_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),middle_name) middle_name_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),preferred_name) preferred_name_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),patient_account_number) patient_account_number_enc,
 EncryptByKey (Key_GUID('SymmetricKey1'),birth_place) birth_place_enc,
  EncryptByKey (Key_GUID('SymmetricKey1'), CONVERT(varchar, death_date,121)) death_date_enc,
   EncryptByKey (Key_GUID('SymmetricKey1'),mother_account_number) mother_account_number_enc
 into resident_temp
 from resident r
 GO

/* CHANGE STRUCTURE OF RESIDENT TABLE SO IT STORE ENCRYPTED DATA (VARBINARY) */

ALTER TABLE resident DROP COLUMN hash_key;

ALTER TABLE resident DROP COLUMN ssn; ALTER TABLE resident ADD ssn varbinary(MAX) ;
DROP INDEX resident.SSN_Last4Digits_Index;
ALTER TABLE resident DROP COLUMN ssn_last_four_digits; ALTER TABLE resident ADD ssn_last_four_digits varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN birth_date; ALTER TABLE resident ADD birth_date varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN medical_record_number; ALTER TABLE resident ADD medical_record_number varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN medicare_number; ALTER TABLE resident ADD medicare_number varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN medicaid_number; ALTER TABLE resident ADD medicaid_number varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN ma_authorization_number; ALTER TABLE resident ADD ma_authorization_number varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN ma_auth_numb_expire_date; ALTER TABLE resident ADD ma_auth_numb_expire_date varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN prev_addr_street; ALTER TABLE resident ADD prev_addr_street varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN prev_addr_city; ALTER TABLE resident ADD prev_addr_city varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN prev_addr_state; ALTER TABLE resident ADD prev_addr_state varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN prev_addr_zip; ALTER TABLE resident ADD prev_addr_zip varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN advance_directive_free_text; ALTER TABLE resident ADD advance_directive_free_text varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN first_name; ALTER TABLE resident ADD first_name varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN last_name; ALTER TABLE resident ADD last_name varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN middle_name; ALTER TABLE resident ADD middle_name varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN preferred_name; ALTER TABLE resident ADD preferred_name varbinary(MAX) ;

ALTER TABLE resident DROP COLUMN birth_place; ALTER TABLE resident ADD birth_place varbinary(MAX) ;
ALTER TABLE resident DROP COLUMN death_date; ALTER TABLE resident ADD death_date varbinary(MAX) ;

ALTER TABLE resident DROP CONSTRAINT [FK_mother_account_number];
ALTER TABLE resident DROP CONSTRAINT [FK_patient_account_number];

ALTER TABLE resident DROP COLUMN mother_account_number; ALTER TABLE resident ADD mother_account_number varbinary(MAX)
ALTER TABLE resident DROP COLUMN patient_account_number; ALTER TABLE resident ADD patient_account_number varbinary(MAX) ;

GO


sp_rename 'resident', 'resident_enc'
GO
