...
values ('ARBITRATION_AGREEMENT',
        'Arbitration agreement',
        '{"day":{"ui:options":{"maxLength":2}},"month":{"ui:field":"SelectField","ui:options":{"isMultiple":false}},"year":{"ui:options":{"maxLength":4}},"facility":{"ui:options":{"maxLength":256}},"resident":{"ui:options":{"maxLength":256}},"arbitrationAgreementSignatures":{"rescissionStartDate":{"ui:field":"DateField"},"facilityName":{"ui:options":{"maxLength":256}},"facilityAddress":{"ui:options":{"maxLength":256}},"facilityAddress2":{"ui:options":{"maxLength":256}},"rescissionEndDate":{"ui:field":"DateField"},"ui:grid":[{"facilityName":{"md":4},"facilityAddress":{"md":4},"facilityAddress2":{"md":4}},{"rescissionStartDate":{"md":6},"rescissionEndDate":{"md":6}}]},"ui:grid":[{"day":{"md":4},"month":{"md":4},"year":{"md":4}},{"facility":{"md":6},"resident":{"md":6}},{"arbitrationAgreementSignatures":{"md":12}}]}',
        '{"type":"object","properties":{"day":{"type":"string","title":"Day","format":"number"},"month":{"title":"Month","enum":["January","February","March","April","May","June","July","August","September","October","November","December"]},"year":{"type":"string","title":"Year","format":"number"},"facility":{"title":"Facility","type":"string"},"resident":{"title":"Resident","type":"string"},"arbitrationAgreementSignatures":{"type":"object","title":"Signatures to Arbitration Agreement","properties":{"rescissionStartDate":{"title":"Date rescission period begins"},"facilityName":{"title":"Facility name","type":"string"},"facilityAddress":{"title":"Facility address","type":"string"},"facilityAddress2":{"title":"Facility address 2","type":"string"},"rescissionEndDate":{"title":"Not later than midnight of (last day for rescission)"}}}}}')
go
...
values (@signature_template_field_id, 'FONT_SIZE', '15.0'),
       (@signature_template_field_id, 'TEXT_ALIGNMENT', 'ALIGN_CENTER')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 167, 94, 259, 109, 1)
...
values (@signature_template_field_id, 'FONT_SIZE', '15.0'),
       (@signature_template_field_id, 'TEXT_ALIGNMENT', 'ALIGN_CENTER')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 283, 94, 306, 109, 1)
...
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 316, 96, 401, 110, 1)
...
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, null, 109, 251, 239, 265, 4)
