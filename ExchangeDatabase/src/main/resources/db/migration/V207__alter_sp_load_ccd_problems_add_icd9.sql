/****** Object:  StoredProcedure [dbo].[load_ccd_problems]    Script Date: 09/26/2016 14:48:18 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	-- pagination & output
	SELECT
		RowNum as id, problem_name, effective_time_low, effective_time_high, problem_status_text,problem_value_code_icd9
	FROM SortedTable
	WHERE
