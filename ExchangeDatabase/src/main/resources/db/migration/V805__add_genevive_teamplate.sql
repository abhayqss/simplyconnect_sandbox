...
values ('GENEVIVE',
        'Genevive',
        '{"patientConsent":{"dob":{"ui:field":"DateField","ui:options":{"isFutureDisabled":true}},"ui:grid":[{"dob":{"md":6}}]},"newPatientInfo":{"patientInfo":{"dob":{"ui:field":"DateField","ui:options":{"isFutureDisabled":true}},"gender":{"ui:field":"RadioGroupField","ui:options":{"view":"row"}},"livingLevel":{"ui:field":"RadioGroupField","ui:options":{"view":"row"}},"patientPhone":{"ui:field":"PhoneField"},"cell":{"ui:field":"PhoneField"},"pharmacy":{"ui:options":{"maxLength":256}},"phone":{"ui:field":"PhoneField"},"fax":{"ui:field":"PhoneField"},"ui:grid":[{"dob":{"md":6},"gender":{"md":6}},{"livingLevel":{"md":7},"patientPhone":{"md":5}},{"cell":{"md":6},"pharmacy":{"md":6}},{"phone":{"md":6},"fax":{"md":6}}]},"ui:grid":[{"patientInfo":{"md":12}}]},"authorization":{"patientInfo":{"dob":{"ui:field":"DateField","ui:options":{"isFutureDisabled":true}},"ui:grid":[{"dob":{"md":6}}]},"ui:grid":[{"patientInfo":{"md":12}}]},"ui:grid":[{"patientConsent":{"md":12}},{"newPatientInfo":{"md":12}},{"authorization":{"md":12}}]}',
        '{"type":"object","properties":{"patientConsent":{"title":"Patient consent to treat and authorizations form","type":"object","properties":{"dob":{"title":"Patient DOB"}}},"newPatientInfo":{"title":"New patient information form","type":"object","properties":{"patientInfo":{"title":"Patient information","type":"object","properties":{"dob":{"title":"DOB"},"gender":{"title":"Gender","enum":["Female","Male","Decline"],"enumNames":["Female","Male","Decline to answer"]},"livingLevel":{"title":"Level of Living","enumNames":["Assisted living","Memory care","Hearth"],"enum":["assistedLiving","memoryCare","hearth"]},"patientPhone":{"title":"Patient Phone"},"cell":{"title":"Cell"},"pharmacy":{"title":"Pharmacy","type":"string"},"phone":{"title":"Phone"},"fax":{"title":"Fax"}}}}},"authorization":{"title":"New patient information Authorization for Release of Information","type":"object","properties":{"patientInfo":{"title":"Patient information","type":"object","properties":{"dob":{"title":"DOB"}}}}}}}')
go
...
insert into DocumentSignatureTemplateField(signature_template_id, name, pdc_flow_type, sc_source_field_type, default_value_type, related_field_id, related_field_value)
values (@signature_template_id, 'legalRepresentativeSignatureDate', 'SIGNATURE_DATE', null, null, (select id from DocumentSignatureTemplateField where name = 'SIGNATURE' and signature_template_id = @signature_template_id), null)
select @signature_template_field_id = scope_identity()
...
values (@signature_template_field_id, 'Male', 389, 134, 397, 142, 3),
       ...
       (@signature_template_field_id, 'Decline', 467, 134, 475, 142, 3)
...
values (@signature_template_field_id, 'FONT_SIZE', '8.0'),
       (@signature_template_field_id, 'FONT_FAMILY', 'HELVETICA')
insert into DocumentSignatureTemplateFieldLocation(signature_template_field_id, field_value, top_left_x, top_left_y, bottom_right_x, bottom_right_y, page_no)
values (@signature_template_field_id, 'assistedLiving', 105, 279, 113, 287, 3),
       (@signature_template_field_id, 'memoryCare', 176, 279, 184, 287, 3),
