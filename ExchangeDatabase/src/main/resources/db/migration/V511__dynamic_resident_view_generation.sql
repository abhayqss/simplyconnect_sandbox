create type COLUMNS_DEFINITION_TYPE as table
(
...
CREATE PROCEDURE update_resident_view
    @toEncrypt COLUMNS_DEFINITION_TYPE READONLY
AS
  BEGIN
    SET NOCOUNT ON;
  ...
  AS
    ...
    select @viewAlterSql = @viewAlterSql + ',' + CHAR(13) + CHAR(10) +
                           ...
                           ']))                    [' + e.column_name + ']'
    from @missingColumns m inner join @toEncrypt e on m.column_name = e.column_name
