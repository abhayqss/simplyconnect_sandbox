...
ALTER TABLE [dbo].[ProspectPrimaryContact] DROP CONSTRAINT [FK_ProspectPrimaryContact_ProspectCareTeamMember]
GO
...
ALTER TABLE [dbo].[SecondOccupant_enc]  WITH CHECK ADD  CONSTRAINT [FK_SecondOccupant_enc_AnyCcdCode_gender] FOREIGN KEY([gender_id])
REFERENCES [dbo].[AnyCcdCode] ([id])
GO

ALTER TABLE [dbo].[SecondOccupant_enc] CHECK CONSTRAINT [FK_SecondOccupant_enc_AnyCcdCode_gender]
GO

ALTER TABLE [dbo].[SecondOccupant_enc]  WITH CHECK ADD  CONSTRAINT [FK_SecondOccupant_enc_AnyCcdCode_marital_status] FOREIGN KEY([marital_status_id])
REFERENCES [dbo].[AnyCcdCode] ([id])
GO

ALTER TABLE [dbo].[SecondOccupant_enc] CHECK CONSTRAINT [FK_SecondOccupant_enc_AnyCcdCode_marital_status]
GO

ALTER TABLE [dbo].[SecondOccupant_enc]  WITH CHECK ADD  CONSTRAINT [FK_SecondOccupant_enc_AnyCcdCode_race] FOREIGN KEY([race_id])
REFERENCES [dbo].[AnyCcdCode] ([id])
GO

ALTER TABLE [dbo].[SecondOccupant_enc] CHECK CONSTRAINT [FK_SecondOccupant_enc_AnyCcdCode_race]
GO

ALTER TABLE [dbo].[SecondOccupant_enc]  WITH CHECK ADD  CONSTRAINT [FK_SecondOccupant_enc_InNetworkInsurance] FOREIGN KEY([in_network_insurance_id])
REFERENCES [dbo].[InNetworkInsurance] ([id])
GO

ALTER TABLE [dbo].[SecondOccupant_enc] CHECK CONSTRAINT [FK_SecondOccupant_enc_InNetworkInsurance]
GO

ALTER TABLE [dbo].[SecondOccupant_enc]  WITH CHECK ADD  CONSTRAINT [FK_SecondOccupant_enc_Person] FOREIGN KEY([person_id])
REFERENCES [dbo].[Person] ([id])
GO

ALTER TABLE [dbo].[SecondOccupant_enc] CHECK CONSTRAINT [FK_SecondOccupant_enc_Person]
GO

ALTER TABLE [dbo].[SecondOccupant_enc]  WITH CHECK ADD  CONSTRAINT [FK_SecondOccupant_enc_SourceDatabase] FOREIGN KEY([database_id])
REFERENCES [dbo].[SourceDatabase] ([id])
GO

ALTER TABLE [dbo].[SecondOccupant_enc] CHECK CONSTRAINT [FK_SecondOccupant_enc_SourceDatabase]
GO
...
ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_AnyCcdCode_gender] FOREIGN KEY([gender_id])
REFERENCES [dbo].[AnyCcdCode] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_AnyCcdCode_gender]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_AnyCcdCode_marital_status] FOREIGN KEY([marital_status_id])
REFERENCES [dbo].[AnyCcdCode] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_AnyCcdCode_marital_status]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_AnyCcdCode_race] FOREIGN KEY([race_id])
REFERENCES [dbo].[AnyCcdCode] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_AnyCcdCode_race]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_InNetworkInsurance] FOREIGN KEY([in_network_insurance_id])
REFERENCES [dbo].[InNetworkInsurance] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_InNetworkInsurance]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_Organization] FOREIGN KEY([organization_id])
REFERENCES [dbo].[Organization] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_Organization]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_Person] FOREIGN KEY([person_id])
REFERENCES [dbo].[Person] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_Person]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_Person_related_party] FOREIGN KEY([person_id])
REFERENCES [dbo].[Person] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_Person_related_party]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_SecondOccupant_enc] FOREIGN KEY([second_occupant_id])
REFERENCES [dbo].[SecondOccupant_enc] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_SecondOccupant_enc]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_SourceDatabase] FOREIGN KEY([database_id])
REFERENCES [dbo].[SourceDatabase] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_SourceDatabase]
GO
...
ALTER TABLE [dbo].[ProspectCareTeamMember]  WITH CHECK ADD  CONSTRAINT [FK_ProspectCareTeamMember_Prospect_enc] FOREIGN KEY([id])
REFERENCES [dbo].[Prospect_enc] ([id])
GO

ALTER TABLE [dbo].[ProspectCareTeamMember] CHECK CONSTRAINT [FK_ProspectCareTeamMember_Prospect_enc]
GO
...
ALTER TABLE [dbo].[ProspectPrimaryContact]  WITH CHECK ADD  CONSTRAINT [FK_ProspectPrimaryContact_ProspectCareTeamMember] FOREIGN KEY([prospect_care_team_member_id])
REFERENCES [dbo].[ProspectCareTeamMember] ([id])
GO

ALTER TABLE [dbo].[ProspectPrimaryContact] CHECK CONSTRAINT [FK_ProspectPrimaryContact_ProspectCareTeamMember]
GO

ALTER TABLE [dbo].[Prospect_enc]  WITH CHECK ADD  CONSTRAINT [FK_Prospect_enc_ProspectPrimaryContact] FOREIGN KEY([primary_contact_id])
REFERENCES [dbo].[ProspectPrimaryContact] ([id])
GO

ALTER TABLE [dbo].[Prospect_enc] CHECK CONSTRAINT [FK_Prospect_enc_ProspectPrimaryContact]
GO
