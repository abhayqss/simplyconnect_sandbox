ALTER TABLE [dbo].[Employee_enc]
  ADD [labs_coordinator] [bit] NOT NULL DEFAULT 0
GO
...
AS
  BEGIN
    ...
    ([inactive], [legacy_id], [password], [database_id], [person_id], [care_team_role_id], [created_automatically],
     ...
     [last_name], [login], [secure_email], [ccn_company], [first_name_hash], [last_name_hash], [login_hash], [qa_incident_reports], [creator_id],[labs_coordinator])
      SELECT
        [inactive],
        [legacy_id],
        [password],
