/****** Object:  StoredProcedure [dbo].[load_ccd_results]    Script Date: 05/29/2015 12:56:31 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[load_ccd_results]
	@ResidentId bigint,
...
BEGIN
	...
	-- select data
	INSERT INTO @T 
		SELECT ro.id, ro.effective_time, ro.result_text, ro.status_code, cc.display_name, ro.result_value, ro.result_value_unit 
...
/****** Object:  StoredProcedure [dbo].[load_ccd_results_count]    Script Date: 05/29/2015 13:01:49 ******/

ALTER PROCEDURE [dbo].[load_ccd_results_count]
	@ResidentId bigint
AS
BEGIN
