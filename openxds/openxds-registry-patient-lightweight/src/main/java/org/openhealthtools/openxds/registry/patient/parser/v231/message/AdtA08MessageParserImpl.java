...
import org.openhealthtools.openxds.entity.message.ADTA08;
...
@Service
public class AdtA08MessageParserImpl implements AdtMessageParser<ADTA08, ADT_A08> {
    ...
    @Override
    public ADTA08 parse(ADT_A08 message) throws HL7Exception, ApplicationException {
        final ADTA08 simplyConnectMessage = new ADTA08();
        ...
        // parsing library bug - it returns A01 type
        if (simplyConnectMessage.getEvn() != null) {
            simplyConnectMessage.getEvn().setEventTypeCode("A08");
        }
    ...
    private List<AdtAL1AllergySegment> parseAllergyList(final ADT_A08 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getAL1Reps(), message, new BiIntFunction<ADT_A08, AdtAL1AllergySegment>() {
            @Override
            public AdtAL1AllergySegment apply(final ADT_A08 parameter, final int i) throws HL7Exception, ApplicationException {
                return getAl1AllergySegmentParser().parse(parameter.getAL1(i));
            }
        });
    }

    //TODO ggavrysh move to common class
    private List<AdtDG1DiagnosisSegment> parseDiagnosisList(final ADT_A08 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getDG1Reps(), message, new BiIntFunction<ADT_A08, AdtDG1DiagnosisSegment>() {
            @Override
            public AdtDG1DiagnosisSegment apply(final ADT_A08 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    //TODO ggavrysh move to common class
    private List<AdtGT1GuarantorSegment> parseGuarantorList(final ADT_A08 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getDG1Reps(), message, new BiIntFunction<ADT_A08, AdtGT1GuarantorSegment>() {
            @Override
            public AdtGT1GuarantorSegment apply(final ADT_A08 parameter, final int i) throws HL7Exception, ApplicationException {
                return getGt1GuarantorSegmentParser().parse(parameter.getGT1(i));
            }
        });
    }

    //TODO ggavrysh move to common class
    private List<PR1ProceduresSegment> parsePR1List(final ADT_A08 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getPR1ROLReps(), message, new BiIntFunction<ADT_A08, PR1ProceduresSegment>() {
            @Override
            public PR1ProceduresSegment apply(final ADT_A08 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    //TODO ggavrysh move to common class
    private List<IN1InsuranceSegment> parseIN1List(final ADT_A08 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getIN1IN2IN3Reps(), message, new BiIntFunction<ADT_A08, IN1InsuranceSegment>() {
            @Override
            public IN1InsuranceSegment apply(final ADT_A08 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    @Override
    public Class<ADT_A08> getMessageClass() {
