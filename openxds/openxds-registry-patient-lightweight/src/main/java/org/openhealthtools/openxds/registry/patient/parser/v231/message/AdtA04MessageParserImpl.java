...
import org.openhealthtools.openxds.entity.message.ADTA04;
...
@Service
public class AdtA04MessageParserImpl implements AdtMessageParser<ADTA04, ADT_A04> {
    ...
    @Override
    public ADTA04 parse(ADT_A04 message) throws ApplicationException, HL7Exception {
        final ADTA04 simplyConnectMessage = new ADTA04();
        ...
        if (simplyConnectMessage.getEvn() != null) {
            simplyConnectMessage.getEvn().setEventTypeCode("A04");
        }
    ...
    private List<AdtAL1AllergySegment> parseAllergyList(final ADT_A04 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getAL1Reps(), message, new BiIntFunction<ADT_A04, AdtAL1AllergySegment>() {
            @Override
            public AdtAL1AllergySegment apply(final ADT_A04 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    private List<AdtDG1DiagnosisSegment> parseDiagnosisList(final ADT_A04 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getDG1Reps(), message, new BiIntFunction<ADT_A04, AdtDG1DiagnosisSegment>() {
            @Override
            public AdtDG1DiagnosisSegment apply(final ADT_A04 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    //TODO ggavrysh move to common class
    private List<AdtGT1GuarantorSegment> parseGuarantorList(final ADT_A04 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getDG1Reps(), message, new BiIntFunction<ADT_A04, AdtGT1GuarantorSegment>() {
            @Override
            public AdtGT1GuarantorSegment apply(final ADT_A04 msg, final int i) throws HL7Exception, ApplicationException {
                return gt1GuarantorSegmentParser.parse(msg.getGT1(i));
            }
        });
    }

    //TODO ggavrysh move to common class
    private List<PR1ProceduresSegment> parsePR1List(final ADT_A04 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getPR1ROLReps(), message, new BiIntFunction<ADT_A04, PR1ProceduresSegment>() {
            @Override
            public PR1ProceduresSegment apply(final ADT_A04 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    //TODO ggavrysh move to common class
    private List<IN1InsuranceSegment> parseIN1List(final ADT_A04 message) throws HL7Exception, ApplicationException {
        return SegmentParserUtil.parseList(message.getIN1IN2IN3Reps(), message, new BiIntFunction<ADT_A04, IN1InsuranceSegment>() {
            @Override
            public IN1InsuranceSegment apply(final ADT_A04 msg, final int i) throws HL7Exception, ApplicationException {
    ...
    @Override
    public Class<ADT_A04> getMessageClass() {
        return ADT_A04.class;
    }
