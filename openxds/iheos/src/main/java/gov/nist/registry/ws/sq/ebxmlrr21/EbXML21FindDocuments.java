...
public class EbXML21FindDocuments extends FindDocuments {
	...
	LoggerException {
		...
		/* todo it is necessary to introduce default xds communities functionality here:
			if patient_id is from default community - lookup should be either with null assigning facility and default community's oid */
