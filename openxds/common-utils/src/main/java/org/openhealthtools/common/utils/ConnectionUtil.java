...
import org.openhealthtools.custom.net.CustomSecureSocketFactory;
...
public class ConnectionUtil {
	...
	public static Protocol getProtocol(IConnectionDescription connection) {
		...
		if (connection.isSecure()) {
			protocol = new Protocol("https", new CustomSecureSocketFactory((SecureConnectionDescription)connection), connection.getPort());
		}
		return protocol;		
	}
}
