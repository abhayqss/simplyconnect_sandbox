...
import org.openhealthtools.custom.net.CustomHL7Server;
...
public class XdsRegistryImpl extends BaseIheActor implements XdsRegistry {
    ...
    private boolean initPixRegistry() {
        ...
        try {
            ...
            pixServer = new CustomHL7Server(pixRegistryConnection, llp, new CustomPipeParser());
            ...
            //Discharge/end visit
            pixServer.registerApplication("ADT", "A03", pixFeed);
