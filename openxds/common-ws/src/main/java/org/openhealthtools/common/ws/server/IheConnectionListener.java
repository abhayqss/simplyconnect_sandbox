...
import org.openhealthtools.common.ws.server.ssl.AxisHttpsConnectionImpl;
...
//              }
                  LOG.debug("Waiting for incoming HTTP connection");
                    ...
                    AxisHttpConnection conn = null;
                    conn = new AxisHttpConnectionImpl(socket, this.params);

                    if (socket instanceof SSLSocket) {
                        conn = new AxisHttpsConnectionImpl((SSLSocket)socket, this.params);
                    } else {
                        conn = new AxisHttpConnectionImpl(socket, this.params);
                    }
