...
@Controller
@RequestMapping(value = "/iti42")
@PreAuthorize("isAuthenticated()")
public class Iti42Controller extends ItiController {

    public static Map<String, String> ITI42_HEADER;
    public static SimpleDateFormat df = new SimpleDateFormat("yyyyMMddHHmmss");
    public static Resource TEMPLATE = new ClassPathResource("/xmltemplates/iti42.xml");

    @Autowired
    HttpSender httpSender;

    @ModelAttribute("itiHeaders")
    public Map<String, String> getIti42Headers() {
        return ITI42_HEADER;
    }

    static {
        ITI42_HEADER = new HashMap<String, String>();
        ITI42_HEADER.put("Content-Type", "application/xop+xml; charset=UTF-8; type=\"application/soap+xml\"");
        ITI42_HEADER.put("SOAPAction", "urn:ihe:iti:2007:RegisterDocumentSet-b");
        ITI42_HEADER.put("User-Agent", "Axis2");
        ITI42_HEADER.put("Content-Transfer-Encoding", "Axis2");
    }
    ...
    public Iti41RequestDto getDefaultValues() {
        ...
        request.setRepositoryUniqueId("1.3.6.1.4.1.21367.2010.1.2");
...
*/
    ...
    public String postRequest(@Valid @ModelAttribute("requestDto") Iti41RequestDto requestDto, Model model) throws Exception {
        ...
        ResponseDto dto = httpSender.sendRequest("https://" + requestDto.getHost() + ":" + requestDto.getPort() + "/axis2/services/xdsregistryb", ITI42_HEADER, requestDto.getTemplate());
