...
@Controller
@RequestMapping(value = "/iti8")
@PreAuthorize("isAuthenticated()")
public class Iti8Controller extends Iti8Iti30BaseController {

    public static Map<String, Resource> templates;

    public static Resource ADT_01_TEMPLATE = new ClassPathResource("/xmltemplates/adt01.hl7");
    public static Resource ADT_08_TEMPLATE = new ClassPathResource("/xmltemplates/adt08.hl7");

    static {

        templates = new HashMap<String, Resource>();
        templates.put("ADT01", ADT_01_TEMPLATE);
        templates.put("ADT08", ADT_08_TEMPLATE);
    ...
    public @ResponseBody String applyTemplate(Model model,
        ...
        String templateSrc = getContentFromFile(templates.get("ADT01"));
        Template template = new Template(templateSrc)
                ...
                .addReplacement("msgType", requestDto.getMsgType())
...
//new PipeParser(), MinLowerLayerProtocol.class,
        ...
        responseDto.setText("<br/>" + responseString.replace("\r", "<br/>"));
//MSH|^~\&|XDSb_REG_MISYS|MISYS|OTHER_KIOSK|HIMSSSANDIEGO|20220602203009.061+0300||ACK^A01^ACK|9733|P|2.5
//MSA|AA|4321234
//ERR|||207^Application internal error^HL70357^^^^^^org.springframework.dao.DataIntegrityViolationException: could not execute statement; SQL [n/a]; constraint [null]; nested exception is org.hibernate.exception.ConstraintViolationException: could not execute statement|E
