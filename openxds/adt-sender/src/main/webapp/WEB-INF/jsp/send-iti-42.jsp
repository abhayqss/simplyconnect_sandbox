...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/send-iti-42.js"></script>
</head>
...
<H1> ITI-42 Register Document Set-b </H1>
    ...
    <div class="panel-body" id="requestBody"
        ...
        <div class="form-group row" style="margin-left: auto;margin-right: auto; width:600px">
            ...
            <div class="col-xs-2 col-xs-offset-2">
                <label> (To calculate hash, size, and title)</label>
                <button id="send-iti42upload" type="button" class="btn btn-primary" onclick="return false">Upload File</button>
            </div>
        ...
        <form:form method="POST" commandName="requestDto" class="container" id="iti42form">
            ...
            <div class="form-group row">
                <div class="col-xs-2 col-xs-offset-2">
                    <button id="apply-values-42" type="button" class="btn btn-primary">Apply Values to Template</button>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-xs-2 col-xs-offset-2">
                    <button id="send-iti42" type="submit" class="btn btn-primary">Send</button>
                </div>
            </div>
        </form:form>
    </div>
