...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/send-adt-03.js"></script>
</head>

<body class="panel-body">
<jsp:include page="header.jsp"/>

<H1> ITI-30 Patient Identity Management </H1>
...
<div class="panel panel-primary">
    ...
    <div class="panel-body" id="requestBody"
        <c:if test="${not empty responseDto}">style="display:none"</c:if>
            >
        <form:form method="POST" commandName="requestDto" class="container" id="iti30form">
            ...
            <div class="form-group row">
                ...
                <%--<div class="col-xs-2">--%>
                    <%--<form:select path="msgType" type="text" class="form-control" id="msgType-input">--%>
                        ...
                        <%--<form:option value="A03">ADT-03</form:option>--%>
...
<c:if test="${not empty responseDto}">
    ...
    <div id="adt-server-response" class="panel ${(responseDto.status!=null) ? 'panel-primary' : 'panel-success'}">
        ...
        <div class="panel-body">
            <label>Status</label> : <span class="${(responseDto.status!=null) ? 'ok' : 'nok'}"> ${responseDto.status}</span>
            <p/>
