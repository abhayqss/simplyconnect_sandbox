...
public interface XdsRegistryPatientService {
     ...
     */
	boolean isValidPatient(PatientIdentifier pid, RegistryPatientContext context) throws RegistryPatientException;
	 ...
	 */
	void createPatient(Patient patient, RegistryPatientContext context, Long msgDbId) throws RegistryPatientException;
	 ...
	 */
	void updatePatient(Patient patient, RegistryPatientContext context, final Long msgDbId) throws RegistryPatientException;
	 ...
	 */
	void mergePatients(Patient survivingPatient, Patient mergePatient, RegistryPatientContext context) throws RegistryPatientException;
	 ...
	 */
	void unmergePatients(Patient survivingPatient, Patient mergePatient, RegistryPatientContext context) throws RegistryPatientException;


	Long getResidentId(PatientIdentifier pid, RegistryPatientContext context) throws RegistryPatientException;
//	public PatientIdentifier getPatientId(Long residentId, RegistryPatientContext context) throws RegistryPatientException;
	void saveRawXdsMessage (String message);

	Long saveXdsMessage(MessageHeader header, Message msgIn) throws HL7Exception, ApplicationException;
}
